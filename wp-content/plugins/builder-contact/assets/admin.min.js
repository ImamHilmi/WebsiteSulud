...
g=a.options.head;var p=a.options.body;const u=a.options.foot,q={text:function(a,b,e){a={id:"field_"+a,placeholder:b,"class":"large",type:"text"};e&&(a.help=e);return c.create([a])},checkbox:function(a){const b={id:"field_"+a,new_line:!0,type:"checkbox",options:[{value:"",name:"yes"}]};"sendcopy_active"===a&&(b.binding={checked:{show:["field_sendcopy_subject"]},not_checked:{hide:["field_sendcopy_subject"]}});"optin_active"===a&&(b.binding={checked:{show:["optin"]},not_checked:{hide:["optin"]}});return c.create([b])}};
for(var m in g){var l=document.createElement("th");"l"===m&&(l.colSpan=2);l.textContent=g[m];e.appendChild(l)}f.appendChild(e);for(var k in p){e=document.createElement("tr");for(var h in g){m=document.createElement("td");l=null;if("f"===h)l=document.createElement("span"),m.textContent=p[k];else if("l"===h){if(m.colSpan="2",l=q.text(k+"_label",p[k]),l.appendChild(q.text(k+"_placeholder",tb_contact_l10n.pl)),"message"!==k){var r=document.createDocumentFragment(),v=q.checkbox(k+"_require");r.appendChild(l);
v.querySelector(".tb_lb_option").appendChild(document.createTextNode(tb_contact_l10n.req));r.appendChild(v);l=r}}else"sh"===h&&(l=q.checkbox(k+"_active"));null!==l&&m.appendChild(l);e.appendChild(m)}t.appendChild(e)}e=document.createElement("tr");k=document.createElement("td");h=document.createElement("a");p=document.createElement("span");h.className="tb_new_field_action";h.href="#";p.className="tf_plus_icon";h.appendChild(p);h.appendChild(document.createTextNode(a.new_row));k.setAttribute("colspan",
"4");k.appendChild(h);e.className="tb_no_sort";e.appendChild(k);t.appendChild(e);d.appendChild(t);for(let b in u)if("align"!==b){e=document.createElement("tr");for(let d in g)if("sh"!==d||"send"!==b)a=document.createElement("td"),h=null,"f"===d?a.textContent=u[b]:"l"===d?(a.colSpan=2,k=q.text(b+"_label",u[b]),"send"===b?(a.colSpan=3,r=document.createDocumentFragment(),h=c.select.render({id:u.align.id,options:u.align.options},c),r.appendChild(k),r.appendChild(h),r.appendChild(document.createTextNode(u.align.label)),
h=r):"optin"===b?(h=document.createDocumentFragment(),p=ThemifyConstructor.create([{type:"optin_provider",id:"optin"}]),h.appendChild(k),h.appendChild(p)):h=k,r.appendChild(v)):"sh"===d&&"send"!==b&&(h=q.checkbox(b+"_active"),"captcha"===b&&""!==tb_contact_l10n.captcha&&h.querySelector("input").addEventListener("change",function(a){a=this.closest("td").previousElementSibling;if(!0===this.checked){const b=document.createElement("div");b.className="tb_captcha_message tb_field_error_msg";b.innerHTML=
tb_contact_l10n.captcha;a.appendChild(b)}else a=a.getElementsByClassName("tb_captcha_message")[0],"undefined"!==typeof a&&a.parentNode.removeChild(a)},{passive:!0})),null!==h&&a.appendChild(h),"l"===d&&"sendcopy"===b&&a.appendChild(c.create([{id:"field_"+b+"_subject",after:tb_contact_l10n.sendcopy_sub,type:"text","class":"small"}])),e.appendChild(a);t.appendChild(e)}n.appendChild(t);b.className="contact_fields";b.appendChild(f);b.appendChild(d);b.appendChild(n);document.addEventListener("tb_editing_contact",
function(a){const d=new w(b,c);Themify.body.one("themify_builder_lightbox_close",function(a){d.$table.off("click.tb_contact keyup.tb_contact change.tb_contact")})},{once:!0});return b}}})(jQuery);
