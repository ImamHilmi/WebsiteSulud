...
(function (Themify, document) {
    ...
    const self = Themify,
            ...
            onInit = function () {
                ...
                if (this.params.autoplay && this.params.autoplay['disableOnInteraction'] === true) {
                    const self = this,
                        ...
                        self.imagesLoad(items[i], function (instance) {
                            ...
                            const data = options ? options : {
                                ...
                                centered: el.getAttribute('data-centered')
									...
									data.auto='continuously'===data.effect?0.5:data.auto;
                            if (maxLen <= 1) {
                            ...
                            if (data['effect'] && data['effect'] !== 'scroll' && (data['effect'] === 'fade' || data['effect'] === 'flip' || data['effect'] === 'cube' || data['effect'] === 'coverflow')) {
                                args['effect'] = data['effect'];
                                if (data['effect'] === 'fade' || data['effect'] === 'flip' || data['effect'] === 'cube') {
                                    args['slidesPerView'] = args['slidesPerGroup'] = 1;
                                    data['mob_visible'] = data['tab_visible'] = 0;
                                }
								if(data['effect'] !== 'fade'){
									args[data['effect']+'Effect']={
                                        slideShadows: false
                                    };
									if('cube'===data['effect']){
										args[data['effect']+'Effect']['shadow']=false;
									}
								}
                            ...
                            if (data['horizontal'] !== true && data.auto && data.auto != '0' && data.auto !== 'off') {
                                const auto = parseFloat(data.auto);
                                args.autoplay = {
