...
a+"% 100%;")):delete e[c+"-frame_repeat"];return f}},multiColumns(a,b,d,e){if("column-count"!==d.prop)return!1;var c=this.getStyleVal(a,e);b=!1;c?(b=d.prop+":"+c+";",c=this.getStyleVal(a+"_gap",e),d=this.getStyleVal(a+"_divider_width",e),""!==c&&void 0!==c?b+="column-gap:"+c+"px;":delete e[a+"_gap"],d?(c=this.getStyleVal(a+"_divider_style",e),a=this.getStyleVal(a+"_divider_color",e),b=b+("column-rule:"+d+"px ")+(c?c:"solid")+(""!==a&&void 0!==a?" "+this.toRGBA(a):""),b+=";"):(delete e[a+"_divider_color"],
delete e[a+"_divider_width"],delete e[a+"_divider_style"])):(delete e[a],delete e[a+"_gap"],delete e[a+"_divider_color"],delete e[a+"_divider_width"],delete e[a+"_divider_style"]);return b},height(a,b,d,e){if("auto"===this.getStyleVal(a+"_auto_height",e))a="height:auto;";else{b=this.getStyleVal(a,e);if(!b)return!1;(a=this.getStyleVal(a+"_unit",e))||(a="px");a="height:"+b+a+";"}return a},filters(a,b,d,e){a={hue:{unit:"deg",prop:"hue-rotate"},saturation:{unit:"%",prop:"saturate"},brightness:{unit:"%",
prop:"brightness"},contrast:{unit:"%",prop:"contrast"},invert:{unit:"%",prop:"invert"},sepia:{unit:"%",prop:"sepia"},opacity:{unit:"%",prop:"opacity"},blur:{unit:"px",prop:"blur"}};b="";for(var c=Object.keys(a),f=0,g=c.length;f<g;++f){var h=this.getStyleVal(d.id+"_"+c[f],e);h?b+=a[c[f]].prop+"("+h+a[c[f]].unit+") ":delete e[d.id+"_"+c[f]]}return""===b?!1:"filter:"+b+";"},text(a,b,d,e){a=this.getStyleVal(a,e);b=!1;void 0!==a&&""!==a&&(b=d.prop+":"+a+";");return b},number(a,b,d,e){return this.fields.text.call(this,
a,b,d,e)},width(a,b,d,e){b=d.prop;d=this.getStyleVal(a,e);if("auto"===d)a="width:auto;";else{if(!d||"width"===b&&"auto"===this.getStyleVal(a+"_auto_width",e))return!1;(a=this.getStyleVal(a+"_unit",e))||(a="px");a=b+":"+d+a+";"}return a},position(a,b,d,e){d=this.getStyleVal(a,e);if(""===d)return!1;b="position:"+d+";";if("absolute"===d||"fixed"===d){d=["top","right","bottom","left"];for(var c,f=d.length-1;0<=f;--f)c=this.getStyleVal(a+"_"+d[f]+"_auto",e),"auto"===c?c="auto":(c=this.getStyleVal(a+"_"+
d[f],e),c=""===c||isNaN(c)?"":c+this.getStyleVal(a+"_"+d[f]+"_unit",e)),b+=""!==c?d[f]+":"+c+";":""}return b}},cleanUnusedStyles(a){for(var b in a){var d=[],e=void 0!==h[b]?h[b].type:null,c=function(a){if(""!==f){a=a.split("_");for(var b=[],c=0,d=a.length;c<d;++c)b.push(a[0]);return b.join("_")+"_"+f}return a};if("background_type"===b||"b_t_h"===b||"background_image"===b||"b_i_h"===b){if("background_image"===b||"b_i_h"===b){var f="b_i_h"===b?"h":"";if(a[c("background_image")])continue;else b="h"===
f?"b_t_h":"background_type",a[b]="image"}f="b_t_h"===b?"h":"";"gradient"!==a[b]?(d=c("background_gradient"),d=[d+"-circle-radial",d+"-gradient",d+"-gradient-angle",d+"-gradient-type"]):d=[c("background_color")];"slider"!==a[b]&&(d.push(c("background_slider")),d.push(c("background_slider_size")),d.push(c("background_slider_mode")),d.push(c("background_slider_speed")));"video"!==a[b]&&(d.push("background_video_options"),d.push("background_video"));e=c("background_image");"image"===a[b]&&a[e]||("video"!==
a[b]&&d.push(e),d.push(c("background_repeat")),d.push(c("background_zoom")),d.push(c("background_position")),d.push(c("background_attachment")));for(e=d.length-1;-1<e;--e)delete a[d[e]]}else if("background_attachment_inner"===b||"b_a_i_h"===b){if(f="b_a_i_h"===b?"h":"",d=c("background_image_inner"),!a[d])for(d=[d,c("background_repeat_inner"),c("background_position_inner"),b],e=d.length-1;-1<e;--e)delete a[d[e]]}else if("cover_color-type"===b||"cover_color_hover-type"===b)for(c="cover_color_hover-type"===
b,!0===c&&"hover_color"===a[b]||!1===c&&"color"===a[b]?(d="cover_gradient",!0===c&&(d+="_hover"),d=[d+"-circle-radial",d+"-gradient",d+"-gradient-angle",d+"-gradient-type"]):d=!0===c?["cover_color_hover"]:["cover_color"],e=d.length-1;-1<e;--e)delete a[d[e]];else if("radio"===e&&-1!==b.indexOf("-frame_type"))for(c=b.replace("-frame_type",""),e=!1,a[b]===c+"-presets"?(d=[c+"-frame_custom"],e=!a[c+"-frame_layout"]||"none"===a[c+"-frame_layout"]):(d=[c+"-frame_layout"],d.push(c+"-frame_color"),e=!a[c+
"-frame_custom"]),e&&(d.push(c+"-frame_color"),d.push(c+"-frame_width"),d.push(c+"-frame_width_unit"),d.push(c+"-frame_height"),d.push(c+"-frame_height_unit"),d.push(c+"-frame_repeat"),d.push(c+"-frame_location")),e=d.length-1;-1<e;--e)delete a[d[e]];else if("background_image-type"===b||"b_i_h-type"===b)for(f="b_i_h-type"===b?"h":"",e=c("background_image"),"image"===a[b]&&(d=c("background_image"),d=[d+"-circle-radial",d+"-gradient",d+"-gradient-angle",d+"-gradient-type"]),"image"===a[b]&&a[e]||(d=
[e,c("background_repeat"),c("background_position")],"image"!==a[b]&&d.push(c("background_color"))),e=d.length-1;-1<e;--e)delete a[d[e]];else if("multiColumns"===e&&-1!==b.indexOf("_count")){if(c=b.replace("_count",""),!a[c])for(d=[c,c+"_gap",c+"_divider_color",c+"_divider_width",c+"_divider_style"],e=d.length-1;-1<e;--e)delete a[d[e]]}else if(a[b]&&-1!==b.indexOf("_apply_all")&&0===b.indexOf("checkbox_")){if(c=b.replace("_apply_all","").replace("checkbox_",""),void 0!==h[c]&&h[c].type===c)for(d=["right",
"bottom","left"],e=0;3>e;++e)delete a[c+"_"+d[e]]}else if("all"===a[b]&&-1!==b.indexOf("-type")){c=b.replace("-type","");var g=["color","style","width"],l=g.length;d=["right","bottom","left"];for(e=d.length-1;-1<e;--e)for(var k=l-1;-1<k;--k)delete a[c+"_"+d[e]+"_"+g[k]]}else"element_font_weight"!==b&&"e_f_w_h"!==b||400!=a[b]?"font_select"!==e||a[b]&&"default"!==a[b]?-1!==b.indexOf("breakpoint_")&&(a[b]=this.cleanUnusedStyles(a[b])):(delete a[b],delete a[b+"_w"]):delete a[b]}return a}};if("undefined"!==
typeof ThemifyBuilderStyle){var l=Object.keys(ThemifyBuilderStyle.points).reverse();l.push("desktop");ThemifyStyles.init(ThemifyBuilderStyle.styles,l);ThemifyBuilderStyle.styles=l=null;if(void 0!==ThemifyBuilderStyle.google){l=ThemifyBuilderStyle.google;ThemifyBuilderStyle.google={};for(var n=l.length-1;-1<n;--n)""!==l[n].value&&"default"!==l[n].value&&(ThemifyBuilderStyle.google[l[n].value]={n:l[n].name,v:l[n].variant});l=null}if(void 0!==ThemifyBuilderStyle.cf){l=ThemifyBuilderStyle.cf;ThemifyBuilderStyle.cf=
{};for(n=l.length-1;-1<n;--n)""!==l[n].value&&"default"!==l[n].value&&(ThemifyBuilderStyle.cf[l[n].value]={n:l[n].name,v:l[n].variant});l=null}l=function(){for(var a in y)if(0===a.indexOf("themify_builder_data_")&&null!==y[a]){var b=a.replace("themify_builder_data_","");ThemifyStyles.builder_id=b;var d=ThemifyStyles.createCss(y[a],null,!0,y["themify_builder_gs_"+b]),e={fonts:[],cf_fonts:[]},c=t.getElementById("themify_builder_content-"+b),f=t.createDocumentFragment();y[a]=null;if(void 0!==d.gs)for(var g in d.gs){var h=
t.createElement("style"),k="";h.type="text/css";h.id="tb_temp_global_styles_"+b;if("desktop"!==g){var m=ThemifyBuilderStyle.points[g];"mobile"!==g&&(m=m[1]);h.media="screen and (max-width:"+m+"px)"}for(var l in d.gs[g])k+=l+"{"+d.gs[g][l].join(" ")+"}";h.appendChild(t.createTextNode(k));f.appendChild(h)}for(g in d)if("gs"!==g&&"bg"!==g)if("fonts"!==g&&"cf_fonts"!==g){h=t.createElement("style");k="";h.type="text/css";h.id="tb_temp_styles_"+b;"desktop"!==g&&(m=ThemifyBuilderStyle.points[g],"mobile"!==
g&&(m=m[1]),h.media="screen and (max-width:"+m+"px)");for(l in d[g])k+=l+"{"+d[g][l].join(" ")+"}";h.appendChild(t.createTextNode(k));f.appendChild(h)}else for(l in d[g])h=l.split(" ").join("+"),0<d[g][l].length&&(h+=":"+d[g][l].join(",")),e[g].push(h);h=Object.keys(e);for(k=h.length-1;0<=k;--k)0<e[h[k]].length?(m="fonts"===h[k]?"//fonts.googleapis.com/css?family="+e[h[k]].join("|"):ThemifyBuilderStyle.cf_api_url+e[h[k]].join("|"),Themify.LoadCss(m,!1)):delete d[h[k]];t.head.appendChild(f);null!==
...
l)}else if(void 0!==y.themifyBuilder){if(void 0!==themifyBuilder.google)for(l=themifyBuilder.google,themifyBuilder.google={},n=l.length-1;-1<n;--n)""!==l[n].value&&"default"!==l[n].value&&(themifyBuilder.google[l[n].value]={n:l[n].name,v:l[n].variant});if(void 0!==themifyBuilder.cf)for(l=themifyBuilder.cf,themifyBuilder.cf={},n=l.length-1;-1<n;--n)""!==l[n].value&&"default"!==l[n].value&&(themifyBuilder.cf[l[n].value]={n:l[n].name,v:l[n].variant})}})(window,document);
