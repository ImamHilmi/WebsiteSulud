...
c.Models.SubRow=z.Model.extend({defaults:{element_id:null,elType:"subrow",gutter:"gutter-default",column_alignment:D?"col_align_middle":"col_align_top",column_h:"",desktop_dir:"ltr",tablet_dir:"ltr",tablet_landscape_dir:"ltr",mobile_dir:"ltr",col_mobile:"-auto",col_tablet_landscape:"-auto",col_tablet:"-auto",cols:{},styling:{}},initialize(){c.Models.Registry.register(this.cid,this);let a=this.get("element_id");a&&1!==A[a]||(a=c.Utils.generateUniqueID(),this.set({element_id:a},{silent:!0}));A[a]=1},
...
a)}});c.Models.Row=z.Model.extend({defaults:{element_id:null,elType:"row",gutter:"gutter-default",column_alignment:D?"col_align_middle":"col_align_top",column_h:"",desktop_dir:"ltr",tablet_dir:"ltr",tablet_landscape_dir:"ltr",mobile_dir:"ltr",col_mobile:"-auto",col_tablet_landscape:"-auto",col_tablet:"-auto",cols:{},styling:{}},initialize(){c.Models.Registry.register(this.cid,this);let a=this.get("element_id");a&&1!==A[a]||(a=c.Utils.generateUniqueID(),this.set({element_id:a},{silent:!0}));A[a]=1},
...
f&&(g=e.get("mod_name"));"sub-column"===f&&(f="column");var k="style"===b||null!==b&&b!==n&&b.classList.contains("tb_paste_style");b=m.Clipboard.get(f);!1===k&&!1===b&&"column"===f&&(b=m.Clipboard.get("module"),f="module",g=b.mod_name);if(!1===b||!0===k&&"module"===f&&g!==b.mod_name)!0!==d&&m.alertWrongPaste();else{c.eventName="row";if(!0===k){var l=ThemifyStyles.getStyleOptions("module"===f?g:f);d="module"===f?"mod_settings":"styling";var h=this.getData(a,"column"===f?e.get("component_name"):f),
q=function(a){if(-1!==a.indexOf("breakpoint_")||-1!==a.indexOf("_apply_all"))return!0;let b=-1!==a.indexOf("_color")?"color":-1!==a.indexOf("_style")?"style":!1;if(!1!==b){if(b=a.replace("_"+b,"_width"),l[b]!==n&&"border"===l[b].type)return!0}else if(-1!==a.indexOf("_unit")){if(b=a.replace(/_unit$/ig,"",""),l[b]!==n)return!0}else if(-1!==a.indexOf("_w")){if(b=a.replace(/_w$/ig,"",""),l[b]!==n&&"font_select"===l[b].type)return!0}else if(l[a]!==n&&"radio"===l[a].type)return!0;return!1};h[d]===n&&(h[d]=
{});for(var t in b[d])l[t]!==n||q(t)?(h[d][t]=b[d][t],l[t]!==n&&(!0===l[t].isFontColor&&b[d][l[t].g+"-gradient"]!==n?h[d][l[t].g+"-gradient"]=b[d][l[t].g+"-gradient"]:(l[t].posId!==n&&b[d][l[t].posId]!==n&&(h[d][l[t].posId]=b[d][l[t].posId]),l[t].repeatId!==n&&b[d][l[t].repeatId]!==n&&(h[d][l[t].repeatId]=b[d][l[t].repeatId])))):delete b[d][t];b.used_gs!==n&&(h.used_gs=b.used_gs);l=null;b=h;delete b.element_id}"column"===f&&(b.grid_class=c.Utils.filterClass(a.prop("class")),a.hasClass("first")?b.grid_class+=
" first":a.hasClass("last")&&(b.grid_class+=" last"),t=a[0].style.width,b.grid_width=t?t.replace("%",""):null,b.component_name=e.get("component_name"));!1===k&&c.Utils.clearElementId([b]);c.hasChanged=!0;!1===k&&"module"===f&&"column"===e.get("elType")&&(e=c.Views.init_module({mod_name:g},!0),f=e.view.render().$el,a[0].getElementsByClassName("tb_holder")[0].appendChild(f[0]),e=e.model,a=f);c.beforeEvent=m.clone(a);e.setData(b);null!==c.activeModel&&m.Lightbox.close()}},importExport(a,b){const d=b.classList.contains("tb_import")?
"import":"export",e=this,f=this.$el,g=this.model;let k=g.get("elType");k="column"===k?g.get("component_name"):k;b=k.charAt(0).toUpperCase()+k.slice(1);const l="subrow"===k?"Sub-Row":"sub-column"===k?"Sub-Column":b;b={contructor:!0,loadMethod:"html",data:{component_form:{name:ThemifyConstructor.label[d+"_tab"].replace("%s",b),options:[{id:"tb_data_field",type:"textarea",label:ThemifyConstructor.label.import_label.replace("%s",l),help:ThemifyConstructor.label[d+"_data"].replace("%s",b),"class":"fullwidth",
rows:13}]}}};"import"===d&&(b.save={});m.Lightbox.$lightbox[0].style.display="none";m.Lightbox.open(b,function(){r.document.body.classList.add("tb_standalone_lightbox")},function(){const b=this.$lightbox;b.addClass("tb_import_export_lightbox");this.setStandAlone(a.clientX,a.clientY);if("import"===d)b.find(".builder_save_button").on("click.tb_import",function(a){a.preventDefault();a.stopPropagation();a=JSON.parse(b.find("#tb_data_field").val());if("column"===k&&"sub-column"===a.component_name||"sub-column"===
k&&"column"===a.component_name)a.component_name=k,a.grid_class=f.closest(".module_column").prop("class");if(a.component_name===n||a.component_name!==k)m.alertWrongPaste();else{c.eventName="row";c.hasChanged=!0;c.beforeEvent=m.clone(f);var d=function(a){a=c.Utils.clear(a);g.setData(a);m.Lightbox.close()};a.used_gs!==n?c.GS.setImport(a.used_gs,d,a):d(a)}});else{let a=e.getData(f,k);a.component_name=k;const d=c.GS.findUsedItems(a);if(!1!==d){const b={};for(let a=d.length-1;-1<a;--a){let e=c.GS.styles[d[a]],
...
null:a=null;let d=c.hasChanged=!1,e=m.Lightbox.$lightbox,f=this.model.get("elType"),g=!1,k="module"===f?this.model.get("mod_name"):f,l=!1;if(null!==a){const e=b.classList;let q=e.contains("tb_dragger")?b.getAttribute("data-id"):null;if(null!==q&&""===b.getAttribute("data-v"))return;"dblclick"===a.type&&this.model.cid!==c.autoSaveCid&&c.ActionBar.clear();l=null!==q||e.contains("tb_styling");if(!0===l)this.model.set({styleClicked:!0},{silent:!0}),null!==q&&(g=function(a){var b=e.contains("tb_dragger_padding")?
"padding":"margin",d="padding"===b?"p":"m";const g=ThemifyConstructor.label[d];let l=n;if("module"===f){let e;l=a.getElementsByClassName("tb_styling_tab_nav")[0];if(l!==n){if(c.EdgeDrag.modules[k]!==n&&c.EdgeDrag.modules[k][b]!==n&&(q=q.replace(/_left|_right|_bottom|_top$/ig,""),c.EdgeDrag.modules[k][b][q]!==n&&(e=c.EdgeDrag.getTabId(ThemifyConstructor.data[k].styling.options.options,q,d),null!==e))){b=l.getElementsByClassName("tb_tab_wrapper")[0].getElementsByTagName("a");for(d=b.length-1;-1<d;--d)if(b[d].getAttribute("href")===
"#tb_1_"+e){b[d].click();break}b=null}e=l.getElementsByClassName("current")[0].getElementsByTagName("a")[0].getAttribute("href");l=a.querySelector(e)}}l===n&&(l=a);const t=l.getElementsByClassName("tb_style_toggle");for(let a=t.length-1;-1<a;--a)if(t[a].textContent===g){t[a].classList.contains("tb_closed")&&t[a].click();setTimeout(function(){h("#tb_lightbox_container").scrollTop(t[a].offsetTop)},10);break}});else if(e.contains("tb_visibility_component"))d=!0,this.model.set({visibileClicked:!0},{silent:!0});
else if(!0===(e.contains("tb_swap")?!1:"layout-part"===k?!0:v.body.triggerHandler("tb_edit_"+k,[a,this.el,this.model]))&&"visual"===c.mode&&!c.Forms.LayoutPart.id&&("dblclick"===a.type||e.contains("tb_edit"))){c.activeModel=this.model;c.Forms.LayoutPart.edit(this.el);return}}null!==c.activeModel&&null!==c.autoSaveCid&&this.model.cid!==c.autoSaveCid&&ThemifyConstructor.saveComponent(!0);c.activeModel=this.model;if(c.autoSaveCid===this.model.cid){a=null;if(!0===l)a=e.find('a[href="#tb_options_styling"]'),
this.model.unset("styleClicked",{silent:!0});else if(!0===d)a=e.find('a[href="#tb_options_visibility"]'),this.model.unset("visibileClicked",{silent:!0});else if("module"===f||"row"===f)a=e.find('a[href="#tb_options_setting"]');null!==a&&0<a.length&&(a[0].click(),!1!==g&&!0===l&&g(m.Lightbox.$lightbox[0].querySelector("#tb_lightbox_container")))}else m.Lightbox.open({loadMethod:"inline",templateID:k},!1,g),!1===c.GS.isGSPage&&(c.ActionBar.hideContextMenu(),("row"!==k||"row"===k&&null!==c.ActionBar.breadCrumbsPath.lightbox)&&
m.Lightbox.$lightbox[0].getElementsByClassName("tb_action_breadcrumb")[0].appendChild(c.ActionBar.getBreadCrumbs(c.Instances.Builder[c.builderIndex].el.getElementsByClassName("tb_element_cid_"+this.model.cid)[0])))},delete(a,b,d){b=this.$el;let e=this.model;a=e.cid;let f=e.get("elType");if(!0===d||confirm(themifyBuilder.i18n[f+"DeleteConfirm"])){null!==c.activeModel&&c.activeModel.cid===a&&m.Lightbox.$lightbox.find(".tb_close_lightbox")[0].click();d=b.closest(".module_row");var g="row",k="",l,u={};
"row"===f?(u.pos_cid=d.next(".module_row"),u.pos="before",0===u.pos_cid.length&&(u.pos="after",u.pos_cid=d.prev(".module_row")),g="delete_row",u.pos_cid=u.pos_cid.data("cid")):a=d.data("cid");d=m.clone(d);"row"!==f&&(l=b.closest(".module_subrow"));e.destroy();l&&0<l.length&&0===l.find(".active_module").length&&l.addClass("tb_row_empty");"row"!==f&&(k=h(".tb_element_cid_"+a),l=k.closest(".module_row"),0===l.find(".active_module").length&&l.addClass("tb_row_empty"));c.hasChanged=!0;c.undoManager.push(a,
d,k,g,u);c.toolbar.pageBreakModule.countModules()}},save(a){null!==c.activeModel&&null!==c.autoSaveCid&&ThemifyConstructor.saveComponent(!0);var b=this.model.get("elType"),d={contructor:!0,loadMethod:"html",save:{done:"save"},data:{}},e=this.model.cid;d.data["s"+b]={options:[{id:"item_title_field",type:"text",label:ThemifyConstructor.label.title},{id:"item_layout_save",type:"checkbox",label:"",options:[{name:"layout_part",value:ThemifyConstructor.label.slayout_part}],new_line:!1,after:"",help:'Any changes made to a Layout Part are saved and reflected everywhere else they are being used (<a href="https://themify.me/docs/builder#layout-parts" target="_blank">learn more</a>)'}]};
m.Lightbox.$lightbox[0].style.display="none";m.Lightbox.open(d,function(){r.document.body.classList.add("tb_standalone_lightbox")},function(d){var f=this.$lightbox,k=function(a){if("keypress"!==a.type||13===a.keyCode){a.preventDefault();a.stopPropagation();m.showLoader("show");a=c.Models.Registry.lookup(e);switch(b){case "row":var f=b;var g=c.Utils._getRowSettings(h(".tb_element_cid_"+e)[0]);c.Utils.clearElementId([g],!0);break;case "module":f=a.get("mod_name"),g={mod_name:f,element_id:c.Utils.generateUniqueID(),
mod_settings:a.get("mod_settings")}}g=c.Utils.clear(g);var k=ThemifyStyles.builder_id;a=h.extend(c.Forms.serialize(d),{action:"tb_save_custom_item",item:JSON.stringify(g),tb_load_nonce:themifyBuilder.tb_load_nonce,postid:k,type:b});f=c.GS.findUsedItems(g);!1!==f&&(a.usedGS=f);var l=a.item_layout_save;h.ajax({type:"POST",url:themifyBuilder.ajaxurl,dataType:"json",data:a,success(a){if("success"===a.status){var d=function(a){h("#tb_module_panel",r.document).find(".tb_module_panel_search_text").val("");
if(l){c.hasChanged=!0;var d={mod_name:"layout-part",mod_settings:{selected_layout_part:a.post_name}};delete a.status;0<ThemifyConstructor.layoutPart.data.length&&ThemifyConstructor.layoutPart.data.push(a);var f=h(".tb_element_cid_"+e),g=m.clone(f);"row"===b?(d=c.Views.init_row({cols:[{grid_class:"col-full first last",element_id:c.Utils.generateUniqueID(),modules:[d]}]}).view.render(),d=c.Models.Registry.lookup(d.$el.find(".active_module").data("cid"))):(d=c.Views.init_module(d),$Elem=d.view.render(),
d=d.model);f.replaceWith($Elem.el);if("visual"===c.mode)h(p).ajaxComplete(function C(a,d,e){-1!==e.data.indexOf("tb_load_module_partial",3)&&(h(this).off("ajaxComplete",C),k="row"===b?c.liveStylingInstance.$liveStyledElmt.closest(".module_row"):c.liveStylingInstance.$liveStyledElmt,c.undoManager.push($Elem.$el.data("cid"),g,k,"row"))}),d.trigger("custom:preview:refresh",d.get("mod_settings"));else{var k=$Elem.el;c.Mixins.Builder.updateModuleSort($Elem.$el);c.undoManager.push($Elem.$el.data("cid"),
g,k,"row")}}if(!0===c.toolbar.libraryItems.is_init){f=h(".tb_library_item_list");a=c.toolbar.libraryItems.template([a]);"visual"===c.mode&&(f=f.add(c.toolbar.$el.find(".tb_library_item_list")));f=f.get();for(let b=0,c=f.length;b<c;++b)f[b].insertAdjacentHTML("afterbegin",a),f[b].previousElementSibling.getElementsByClassName("current")[0].click();c.toolbar.libraryItems.bindEvents(!0)}m.showLoader("hide");m.Lightbox.close()};l?(ThemifyStyles.builder_id=a.id,c.Utils.saveCss([g],"",a.id).done(function(){ThemifyStyles.builder_id=
k;d(a)})):d(a)}else alert(a.msg)}})}};f.addClass("tb_save_module_lightbox");this.setStandAlone(a.clientX,a.clientY);f.on("click.saveLayout",".builder_save_button",k).on("keypress.saveLayout","input",k);v.body.one("themify_builder_lightbox_close",function(){f.removeClass("tb_save_module_lightbox").off(".saveLayout");r.document.body.classList.remove("tb_standalone_lightbox")})})}});c.Views.BaseElement.extend=function(a){const b=this,c=z.View.extend.apply(this,arguments);c.prototype.events=_.extend({},
this.prototype.events,a.events);c.prototype.initialize=function(){"function"===typeof b.prototype.initialize&&b.prototype.initialize.apply(this,arguments);"function"===typeof a.initialize&&a.initialize.apply(this,arguments)};return c};c.Views.Modules["default"]=c.Views.BaseElement.extend({tagName:"div",attributes(){const a=this.model.get("mod_settings"),b={"data-cid":this.model.cid,"class":"active_module module-"+this.model.get("mod_name")+" tb_"+this.model.get("element_id")+" tb_element_cid_"+this.model.cid};
if("visual"===c.mode){if(b["class"]+=" tb_module_front","hide_all"===a.visibility_all||"hide"===a.visibility_desktop||"hide"===a.visibility_tablet||"hide"===a.visibility_tablet_landscape||"hide"===a.visibility_mobile)b["class"]+=" tb_visibility_hidden"}else b["class"]+=" tb_module";a.custom_css_id!==n&&""!==a.custom_css_id&&(b.id=a.custom_css_id);return b},template:"visual"===c.mode?null:wp.template("builder_module_item"),initialize(){this.listenTo(this.model,"dom:module:unsaved",this.removeUnsaved)},
removeUnsaved(){this.model.destroy()},render(){"visual"!==c.mode&&(this.el.innerHTML=this.template(this.model.toRenderData()));c.Utils.visibilityLabel(this.el);return this}});c.Views.Columns["default"]=c.Views.BaseElement.extend({tagName:"div",attributes(){const a={"class":"module_column tb_element_cid_"+this.model.cid+" tb_"+this.model.get("element_id")+" tf_box "+this.model.get("grid_class"),"data-cid":this.model.cid};this.model.get("grid_width")&&(a.style="width:"+this.model.get("grid_width")+
"%");a["class"]+="column"!==this.model.get("component_name")?" sub_column":" tb-column";return a},render(){const a=this.model.get("modules");this.el.innerHTML=m.templateCache.get("tmpl-builder_column_item");if(a){const d=this.el.getElementsByClassName("tb_holder")[0];for(let e in a)if(a[e]!==n&&null!==a[e]){var b=a[e];(b=b.cols===n?c.Views.init_module(b):c.Views.init_subrow(b))&&d.appendChild(b.view.render().el)}"sub-column"===this.model.get("component_name")&&d.classList.add("tb_subrow_holder")}return this}});
c.Views.SubRows["default"]=c.Views.BaseElement.extend({tagName:"div",attributes(){return{"class":"module_subrow themify_builder_sub_row active_module tb_element_cid_"+this.model.cid+" clearfix tf_box tf_w tb_"+this.model.get("element_id"),"data-cid":this.model.cid}},render(){const a=this.model.get("cols"),b=Object.keys(a).length;this.el.innerHTML=m.templateCache.get("tmpl-builder_subrow_item");if(0<b){const d=this.el.getElementsByClassName("subrow_inner")[0];let e=!1;for(let f=0;f<=b;++f)a[f]!==n&&
null!==a[f]&&(a[f].component_name="sub-column",d.appendChild(c.Views.init_column(a[f]).view.render().el),!1===e&&a[f].modules!==n&&0<a[f].modules.length&&(e=!0));!1===e&&this.el.classList.add("tb_row_empty")}c.Utils.selectedGridMenu(this.el,"subrow");c.Utils.visibilityLabel(this.el);return this}});c.Views.Rows["default"]=c.Views.BaseElement.extend({tagName:"div",attributes(){const a=this.model.get("styling"),b={"class":"module_row themify_builder_row tb_element_cid_"+this.model.cid+" clearfix tf_box tb_"+
this.model.get("element_id"),"data-cid":this.model.cid};null!==a&&(a.custom_css_row!==n&&""!==a.custom_css_row&&(b["class"]+=" "+a.custom_css_row),a.custom_css_id!==n&&""!==a.custom_css_id&&(b.id=a.custom_css_id));return b},render(){const a=this.model.get("cols"),b=Object.keys(a).length;let d=!1;this.el.innerHTML=m.templateCache.get("tmpl-builder_row_item");const e=this.el.getElementsByClassName("row_inner")[0];if(0<b)for(let f=0;f<=b;++f)a[f]!==n&&null!==a[f]&&(a[f].component_name="column",e.appendChild(c.Views.init_column(a[f]).view.render().el),
!1===d&&a[f].modules!==n&&(0<a[f].modules.length||"object"===typeof a[f].modules&&0<Object.keys(a[f].modules).length)&&(d=!0));else c.Utils._addNewColumn({newclass:"col-full",component:"column"},e);!1===d&&this.el.classList.add("tb_row_empty");c.Utils.selectedGridMenu(this.el,"row");c.Utils.visibilityLabel(this.el);return this}});c.Views.Builder=z.View.extend({type:"default",lastRow:null,events:{"click .tb_import_layout_button":"importLayoutButton"},initialize(){this.$el.off("tb_init tb_new_row").on("tb_init",
this.init.bind(this)).on("tb_init",this.newRowAvailable.bind(this))},init(a){c.Mixins.Builder.rowSort(this.$el);"visual"===c.mode?(c.Mixins.Builder.updateModuleSort(this.$el),setTimeout(function(){c.Utils._onResize(!0)},1500)):(c.Mixins.Builder.updateModuleSort(this.$el),c.Mixins.Builder.initModuleDraggable(c.toolbar.$el.find(".tb_module_panel_modules_wrap").first(),".tb_module"),c.Mixins.Builder.initModuleDraggable(c.toolbar.$el,".tb_row_grid"));const b=this;setTimeout(function(){c.ActionBar.init();
c.Utils.setCompactMode(b.el.getElementsByClassName("module_column"));b.insertLayoutButton();"visual"!==c.mode&&c.GS.init()},1E3);A={}},render(){const a=this.collection;c.Utils.clearLastEmptyRow(a.models);for(let b=0,d=a.models.length;b<d;++b){let d=c.Views.init_row(a.models[b]);!1!==d&&this.el.appendChild(d.view.render().el)}c.Utils.columnDrag(!1,!1);return this},insertLayoutButton(){this.removeLayoutButton();this.lastRowAddBtn();var a=this.el.getElementsByClassName("module_row");a[0]!==n&&2>a.length&&
a[0].classList.contains("tb_row_empty")&&(a=p.createElement("a"),a.className="tb_import_layout_button",a.href="#",a.textContent=themifyBuilder.i18n.text_import_layout_button,this.el.appendChild(a))},removeLayoutButton(){const a=this.el.getElementsByClassName("tb_import_layout_button");for(let b=a.length-1;-1<b;--b)a[b].parentNode.removeChild(a[b])},importLayoutButton(a){c.Views.Toolbar.prototype.loadLayout(a)},newRowAvailable(a,b){const d=this.el.children,e=d.length;let f=!0;if(0!==e&&!0!==b)for(b=
e-1;-1<b;--b)if(d[b].classList.contains("module_row")){f=!1;break}if(!0===f)return a=c.Views.init_row(c.Utils.grid(a||1)[0]).view.render().$el,a[0].className+=" tb_new_row",this.el.insertBefore(a[0],this.lastRow),c.Utils.setCompactMode(a[0].getElementsByClassName("module_column")),c.Mixins.Builder.update(a),c.Utils.calculateHeight(),a},lastRowShowHide(a){this.lastRow&&(a?this.lastRow.classList.remove("hide"):(this.lastRow.classList.remove("expanded"),this.lastRow.classList.add("hide")))},lastRowAddBtn(){if(!0!==
c.GS.isGSPage){var a=p.getElementById("tb_add_container"),b=p.createElement("div");null!==a&&a.parentNode.removeChild(a);this.lastRow=p.createElement("div");var d=null;this.lastRow.id="tb_add_container";b.className="tb_last_add_btn";b.textContent="+";this.lastRow.appendChild(b);this.lastRow.addEventListener("click",function(a){a.preventDefault();const b=a.target,e=b.closest(".tb_row_grid");null!==e?(this.classList.remove("expanded"),c.Mixins.Builder.rowDrop(c.Utils.grid(e.dataset.col),h("<div>").insertBefore(this),
!0,!0)):b.classList.contains("tb_add_blocks")?(this.classList.remove("expanded"),c.toolbar.common.show(a,h(this).find(".tb_last_add_btn")),c.toolbar.common.clicked=this.previousElementSibling?h(this.previousElementSibling):null,c.toolbar.common.btn[0].querySelector('[data-target="tb_module_panel_rows_wrap"]').click()):b.classList.contains("tb_last_add_btn")&&(null===d&&(d=!0,this.appendChild(p.getElementById("tmpl-last_row_add_btn").content.cloneNode(!0))),this.classList.add("expanded"))});this.el.appendChild(this.lastRow)}}});
c.Mixins.Builder={before:null,zindex:null,r:null,w:null,h:null,type:null,moduleHolderArgs:null,isFullWidth:null,update(a){if("visual"===c.mode){var b=null!==c.activeModel?c.activeModel.get("elType"):c.Models.Registry.lookup(a.data("cid")).get("elType");c.Utils.loadContentJs(a,b)}a=a.closest(".module_row");c.Utils.columnDrag(a.find(".row_inner"),!1);c.Utils.columnDrag(a.find(".subrow_inner"),!1);c.Mixins.Builder.updateModuleSort(a)},dragScroll(a,b){function d(a,b){l=!0;if(null===k){k=!0;var c=this!==
n?this.id:null;c||(c=b);a=("tb_toolbar"===c||"wpadminbar"===c?"-":"+")+("="+g*u+"px");f.stop().animate({scrollTop:a},{duration:1,complete(){!0===l&&(10>u&&++u,k=null,d(null,c))}})}}var e=h("body",r.document);"visual"===c.mode&&(e=e.add(v.body));this.top===n&&(this.top=c.toolbar.$el,this.top=this.top.add(h("#tb_fixed_bottom_scroll",r.document)),"visual"!==c.mode&&(this.top=this.top.add("#wpadminbar")));if(!0===b)this.top.off("mouseenter mouseleave"),"row"===a&&"visual"===c.mode&&c.toolbar.$el.find('.tb_zoom[data-zoom="100"]').trigger("click"),
e.removeClass("tb_drag_start tb_drag_"+a);else{var f=null,g=1,k=null,l=!0,u=1;"visual"!==c.mode&&(f=h(".edit-post-layout__content").first(),0===f.length?f=null:g/=2);null===f&&(f="desktop"===c.activeBreakPoint?h("body,html"):h("body,html",r.document));e.addClass("tb_drag_start tb_drag_"+a);"row"===a&&"visual"===c.mode&&c.toolbar.$el.find('.tb_zoom[data-zoom="50"]').trigger("click");if(0<g)this.top.off("mouseenter").on("mouseenter",d).off("mouseleave").on("mouseleave",function(){u=1;k=l=null;f.stop()})}},
...
c.mode?"parent":"body",tolerance:"pointer",forceHelperSize:!0,forcePlaceholderSize:!0,scroll:!1,beforeStart(a,e,k){b.before||(c.ActionBar.hoverCid=null,d=c.ActionBar.disable=!0,b.before=k.item.next(".module_row"),0===b.before.length&&(b.before=k.item.prev(".module_row"),d=!1),b.before=b.before.data("cid"),b.dragScroll("row"))},start(){a.sortable("refreshPositions")},stop(a,e){c.ActionBar.disable=null;b.before=d=null;b.dragScroll("row",!0)},update(a,e){if("visual"===c.mode&&!e.item[0].classList.contains("tb_row_grid")){var f=
...
c.ActionBar.type="subrow";else{var g=b.next(".tb_holder");0<g.length?g.prepend(a):(g=b.prev(".tb_holder"),g.append(a))}if(d){e=a.next(".module_row");var k=!0;0===e.length&&(k=!1,e=a.prev(".module_row"));e=e.data("cid");f="grid_sort"}c.Utils.setCompactMode(a[0].getElementsByClassName("module_column"));c.Mixins.Builder.update(a);b.remove();c.hasChanged=!0;b=a.closest(".module_row");d||b.removeClass("tb_row_empty");b.find(".tb_row_grid").remove();c.Utils.scrollToDropped(a[0]);c.undoManager.push(b.data("cid"),
e,b,f,{next:k})}else b.remove()},rowDrop(a,b,d,e){function f(){var a=b.prev(".module_row");if(0===a.length){var d="visual"===c.mode?b.closest(".themify_builder_content").data("postid"):null;a=!1}else a=a.data("cid");b[0].innerHTML="";c.ActionBar.type="row";b[0].parentNode.replaceChild(k,b[0]);c.hasChanged=!0;c.Instances.Builder[c.builderIndex].removeLayoutButton();c.undoManager.push("","","","predesign",{prev:a,rows:l,bid:d});a=0;for(d=l.length;a<d;++a){var e=l[a][0].getElementsByClassName("module_column");
0===a&&l[a][0].classList.add("tb_element_clicked");c.Utils.setCompactMode(e);c.Mixins.Builder.update(l[a])}c.Utils.scrollToDropped(l[0][0]);m.showLoader("hide");c.Utils.calculateHeight()}c.ActionBar.clear();var g=function(a){for(var b in a)if(a[b].styling&&0<Object.keys(a[b].styling).length||a[b].modules&&0<Object.keys(a[b].modules).length)return!0;return!1},k=p.createDocumentFragment(),l=[],h=[];e||c.Utils.clearLastEmptyRow(a);for(let b=0,f=a.length;b<f;++b)if(!0===d||a[b].styling&&0<Object.keys(a[b].styling).length||
a[b].cols&&g(a[b].cols))if(e=c.Views.init_row(a[b]),!1!==e){e=e.view.render();k.appendChild(e.el);if("visual"===c.mode){let a=e.el.querySelectorAll("[data-cid]");h[e.el.dataset.cid]=1;for(let b=0,c=a.length;b<c;++b)h[a[b].dataset.cid]=1}l.push(e.$el)}"visual"===c.mode?(c.bootstrap(h,f),h=null):f()},moduleDrop(a,b,d){function e(e){function f(e){k||l.model.set({is_new:1},{silent:!0});e=!0===e?l.model.getPreviewSettings():l.model.get("mod_settings");b?b.hasClass("tb_module_front")?b.after(h.el):b.append(h.el):
a.replaceWith(h.el);k?c.activeModel=l.model:l.model.trigger("edit",null);c.hasChanged=!0;let f=!1;if("visual"===c.mode&&"layout-part"!==l.model.get("mod_name")&&1<=Object.keys(e).length){var t=e.cid;"part"===g||"ajax"===a.data("type")?(f=!0,l.model.trigger("custom:preview:refresh",e)):"module"!==g?l.model.trigger("custom:preview:live",e):c.Utils.loadContentJs(h.$el,"module")}k&&(f&&(e=l.view.$el.find(".tb_preview_component").detach(),l.view.$el.prepend(e)),d&&(t=h.$el.closest(".module_row"),t.removeClass("tb_row_empty").find(".tb_module_dragging_helper").remove(),
h.$el.closest(".module_subrow").removeClass("tb_row_empty"),c.undoManager.push(t.data("cid"),d,t,"row"),t=t.data("cid"),c.Instances.Builder[c.builderIndex].removeLayoutButton(),c.activeModel=null),c.Utils.calculateHeight());c.Utils.scrollToDropped(null,t)}const l=c.Views.init_module(e,!0),h=l.view.render();"visual"===c.mode&&k?(e=[],e[l.model.cid]=1,c.bootstrap(e,f)):f(!0);return h}c.ActionBar.clear();if(a[0].classList.contains("tb_row_grid"))this.subRowDrop(a.data("slug"),a);else{var f={mod_name:a.data("module-slug")},
g=a.data("type"),k="part"===g||"module"===g;if(k)c.toolbar.libraryItems.get(a.data("id"),g,e);else return e(f);"visual"!==c.mode&&h(".themify-wp-editor-holder").addClass("themify-active-holder")}},toJSON(a){const b=[];a=a.children;for(let d=0,e=a.length;d<e;++d)if(a[d].classList.contains("module_row")){let e=c.Utils._getRowSettings(a[d]);0<Object.keys(e).length&&b.push(e)}return b},columnHover(a){for(var b=a.closest(".sub_column"),d=c.Instances.Builder[c.builderIndex].el.getElementsByClassName("tb_hover_sub_column"),
...
d.toggleClass("tb_row_empty",0===d.find(".active_module").length),d=null,h(".tb_element_cid_"+f).replaceWith(b),d=b.closest(".module_row"),d.toggleClass("tb_row_empty",0===d.find(".active_module").length),d=null;else if("row_sort"===e){g=d.cid;var k=d.data[a?"bnext":"anext"];d=h(".tb_element_cid_"+d.data[a?"before":"after"]);f=h(".tb_element_cid_"+g);b=m.clone(f);f.remove();f=null;this.set(b);k?d.before(b):d.after(b);this.doScroll(b)}else if("save"===e){g=d.cid;e=c.Models.Registry.lookup(g);var l=
"module"===e.get("elType"),u=l?"mod_settings":"styling";if(l&&d.data.column)a?(d=h(".tb_element_cid_"+g).closest(".module_row"),g=!1,this.doScroll(f).remove()):(g=d.data.column.data("cid"),b=m.clone(d.data.column),f=h(".tb_element_cid_"+g),this.doScroll(f),this.set(b),f.replaceWith(b),d=b.closest(".module_row")),d.toggleClass("tb_row_empty",0===d.find(".active_module").length),d=null;else{this.doScroll(f);l={};a?(b=m.clone(d.before),l[u]=d.data.bsettings):(b=m.clone(d.after),l[u]=d.data.asettings);
if("visual"===c.mode){d=h.extend(!0,{},d.data.styles);for(var q in d){var t=ThemifyStyles.getSheet(q);t=t.cssRules?t.cssRules:t.rules;for(k in d[q])if(t[k])for(var w in d[q][k])t[k].style["backgroundClip"===w||"background-clip"===w?"WebkitBackgroundClip":w]=a?d[q][k][w].b:d[q][k][w].a}d=c.activeModel;k=l[u][c.GS.key]!==n?l[u][c.GS.key].split(" "):[];c.activeModel=e;c.GS.liveInstance=null;c.GS.generateValues(null,k,!0);c.activeModel=d;c.GS.liveInstance=null}e.set(l,{silent:!0});l=null;this.set(b);
f.replaceWith(b)}}else if("predesign"===e)if(f=d.data.rows,a)for(this.doScroll(h(".tb_element_cid_"+f[0].data("cid"))),k=0,e=f.length;k<e;++k)h(".tb_element_cid_"+f[k].data("cid")).remove();else{q=p.createDocumentFragment();b=[];k=0;for(e=f.length;k<e;++k)w=m.clone(f[k]),q.appendChild(w[0]),b.push(w);!1!==d.data.prev?this.doScroll(h(".tb_element_cid_"+d.data.prev)).after(q):this.doScroll("visual"===c.mode?h("#themify_builder_content-"+d.data.bid):h("#tb_row_wrapper")).prepend(q);k=0;for(e=b.length;k<
e;++k)this.set(b[k]),c.Mixins.Builder.update(b[k])}else if("import"===e){f=h('[data-postid="'+d.data.bid+'"]');d=a?d.data.before:d.data.after;var B=this;d=m.clone(d);f.children().remove();f.prepend(d);d.each(function(){B.set(h(this))})}else"grid_sort"===e&&(a?h(".tb_element_cid_"+d.cid).remove():(f=h(".tb_element_cid_"+d.before),b=m.clone(d.after),g=d.cid,d.data.next?f.before(b):f.after(b),this.set(b)));g&&(c.ActionBar.hoverCid=null,c.Mixins.Builder.update(h(b)));a?--this.index:++this.index;this.is_working=
...
b=this,c,e,f,g,k=a.getElementsByClassName("tb_resizable"),l,u,q=null,t=function(d){var k=c+g-d.clientX,h=null;if("w"===u||"sw"===u||"nw"===u){var t=a.style.width;h=parseInt(a.style.left)+parseInt(t)-k}if("w"!==u){if("y"===u||"-y"===u||"sw"===u||"se"===u||"nw"===u||"ne"===u)if(t="-y"===u||"ne"===u||"nw"===u?e+f-d.clientY:f+d.clientY-e,50<=t&&t<=q){if("-y"===u||"ne"===u||"nw"===u)a.style.top=parseInt(a.style.top)+parseInt(a.style.height)-t+"px";a.style.height=t+"px"}"sw"!==u&&"nw"!==u&&(k=g+d.clientX-
c)}if("y"!==u&&"-y"!==u){if(500<k||120>k)t=k,k=120>k?120:500,null!==h&&(h=h+t-k);null!==h&&(a.style.left=h+"px");a.style.width=k+"px";d=b.getPanelClass(k);l!==d&&(l&&a.classList.remove(l),a.classList.add(d),l=d,b._setResponsiveTabs(d))}},w=function(){r.document.body.classList.remove("tb_start_animate");r.document.body.classList.remove("tb_panel_resize");r.document.removeEventListener("mousemove",t,{passive:!0});r.document.removeEventListener("mouseup",w,{passive:!0});c=g=u=l=null;b.updateStorage()},
B=k.length-1;-1<B;--B)k[B].addEventListener("mousedown",function(b){1===b.which&&(r.document.body.classList.add("tb_start_animate"),r.document.body.classList.add("tb_panel_resize"),u=this.dataset.axis,c=b.clientX,e=b.clientY,q=h(x).height()-50,f=parseInt(h(a).outerHeight(),10),g=parseInt(h(a).outerWidth(),10),r.document.addEventListener("mousemove",t,{passive:!0}),r.document.addEventListener("mouseup",w,{passive:!0}))},{passive:!0})},setFloat(){var a=this.Panel.el.find("#tb_module_panel");a[0].classList.add("tb_panel_floating");
...
e=h(a.currentTarget.closest("ul"));a=b.layoutsList?{loadMethod:"html",data:b.layoutsList}:{data:{action:"tb_load_layout"}};m.Lightbox.$lightbox[0].style.display="none";e.addClass("tb_current_menu_selected");v.body.off("themify_builder_lightbox_close.loadLayout");m.Lightbox.open(a,function(){d.classList.add("tb_load_layout_active");d.classList.add("tb_standalone_lightbox")},function(){function a(){k.on("click.loadLayout",".layout_preview img",function(a){a.preventDefault();a.stopPropagation();var d=
...
nonce:themifyBuilder.tb_load_nonce,layout_slug:d.data("slug"),layout_group:e,mode:"no"!==a?1:0},beforeSend(){"visual"===c.mode&&m.showLoader("show")},success(a){a.data?(a.gs&&(c.GS.styles=h.extend(!0,{},a.gs,c.GS.styles)),f(a.data),m.showLoader()):(m.showLoader("error"),alert(a.msg),m.Lightbox.close())}})},{buttons:{no:{label:ThemifyConstructor.label.layout_replace},yes:{label:ThemifyConstructor.label.layout_append}}})})}function g(){a();const b=l.find(".layout_preview_list");u.show().find("li").on("click",
function(a){a.preventDefault();a.stopPropagation();this.classList.contains("current")||(a=b,this.classList.contains("all")||(b.hide(),a=b.filter("[data-category"+(""!==themifyBuilder.paths.layouts_index?"*":"")+'="'+h(this).text()+'"]')),a.show(),h(this).addClass("current").siblings().removeClass("current"),u.parent().find(".tb_ui_dropdown_label").html(h(this).text()));c.Utils.hideOnClick(u)});u.find(".tb_selected_cat").click();k.find("#tb_layout_search").on("keyup",function(){let a=h.trim(h(this).val());
var c=b;""!==a&&(c=u.find("li.all"),c[0].classList.contains("current")||c.click(),b.hide(),c=b.find(".layout_title:contains("+a+")").closest(".layout_preview_list"));c.show()})[0].focus();v.body.one("themify_builder_lightbox_close.loadLayout",function(){k.off("click.loadLayout")[0].classList.remove("tb_predesigned_lightbox");l.find("#tb_layout_search").off("keyup");l=k=null;d.classList.remove("tb_load_layout_active");d.classList.remove("tb_standalone_lightbox");e.removeClass("tb_current_menu_selected")})}
var k=this.$lightbox,l=k.find("#tb_tabs_pre-designed");if(0===l.length)d.classList.remove("tb_load_layout_active"),d.classList.remove("tb_standalone_lightbox"),e.removeClass("tb_current_menu_selected"),a();else{k[0].classList.add("tb_predesigned_lightbox");this.setStandAlone(r.innerWidth/2,(r.document.documentElement.clientHeight-k.height())/2,!0);var u=l.find(".tb_ui_dropdown_items");b.layoutsList?g():h.ajax({type:"POST",url:themifyBuilder.ajaxurl,dataType:"json",data:{action:"tb_load_predesigned_layouts",
...
c.toolbar.$el.find(".tb_item_"+d+'[data-id="'+a+'"]'):c.toolbar.common.btn.find(".tb_item_"+d+'[data-id="'+a+'"]');b=b.add(f);if("part"===d){b=b.add(h(".themify_builder_content-"+a).closest(".active_module"));f=ThemifyConstructor.layoutPart.data;for(var k=f.length-1;-1<k;--k)if(f[k].post_name===e){ThemifyConstructor.layoutPart.data.splice(k,1);break}}e=b.parent().siblings(".tb_library_types").find(".current");b.remove();e.trigger("click")}else m.showLoader("error")},error(){m.showLoader("error")}})}}},
...
g=f.length;for(let d=0;d<g&&!(10<=e&&n==a);d++){let g=this.items[f[d]];var h=""!==a?new RegExp(a,"i"):!1;if(!h||!h.test(g.title))continue;var l=g.category.split(",");if("All"!==b&&-1===l.indexOf(b))continue;delete this.items[f[d]];h="";for(let a=0,b=l.length;a<b;++a)h+=this.categories[l[a]].hash;l=p.createElement("div");let k=p.createElement("figure"),u=p.createElement("div"),m=new Image,r=p.createElement("a");l.className="predesigned_row "+h;l.setAttribute("data-slug",g.slug);k.className="tb_predesigned_rows_image";
u.className="tb_predesigned_rows_title";u.textContent=m.alt=m.title=g.title;m.src=g.thumbnail===n||""===g.thumbnail?"https://placeholdit.imgix.net/~text?txtsize=24&txt="+encodeURI(g.title)+"&w=181&h=77":g.thumbnail;m.width=500;m.height=300;r.href="#";r.className="tf_plus_icon add_module_btn tb_disable_sorting";r.dataset.type="predesigned";k.appendChild(m);k.appendChild(r);l.appendChild(k);l.appendChild(u);c.appendChild(l);++e}this.categories[b].isLoaded=10>e&&n===a;return c},setData(a){this.items=
...
filter(a){a.preventDefault();a.stopPropagation();a=h(a.currentTarget);const b=a.data("slug"),d=a.closest(".tb_module_panel_tab"),e=d.find(".tb_ui_dropdown_label"),f=d.find(".predesigned_row"),g=a.text();this.currentCategory=g;this.addNewItems();e.text(g);d.find(".tb_module_panel_search_text").val("");const k=b?"tb"+b:!1;e.data("active",k);a.addClass("current").siblings().removeClass("current");f.each(function(){!k||this.classList.contains(k)?h(this).show():h(this).hide()}).filter(":visible").each(function(a){0===
...
k=this.classList,l=this.dataset.type;a.clicked||(a.clicked=c.Instances.Builder[c.builderIndex].newRowAvailable(1,!0),e=!0);if("module"===l)d=a.clicked.hasClass("tb_module_btn_plus")?a.clicked.parent():a.clicked.closest(".module_column").find(".tb_holder").last(),c.toolbar.Panel.add_module(b,d);else if("row"===l)d=a.clicked.hasClass("tb_module_btn_plus")?a.clicked.parent():a.clicked.closest(".module_column").find(".tb_holder").first(),c.toolbar.Panel.click_add_sub_row(b,d);else if(k.contains("js-tb_module_panel_acc"))c.toolbar.toggleAccordion(b);
else if("predesigned"===l||"page_break"===l)d=a.clicked.closest(".module_row"),"page_break"===l?c.toolbar.Panel.click_add_page_break(b,d):c.toolbar.preDesignedRows.get(h(b.currentTarget).closest(".predesigned_row").data("slug"),function(a){c.Mixins.Builder.rowDrop(a,e?d:h("<div>").insertAfter(d),!0)});k.contains("js-tb_module_panel_acc")||a.hide(!0)}).on("keyup",".tb_module_panel_search_text",this.search.bind(this)).on("click",".tb_clear_input",this.clear)},run(){var a=c.toolbar.$el.find("#tb_module_panel");
...
r.document)),"desktop"!==c.activeBreakPoint&&(h("body",r.document).height(p.body.scrollHeight),v.body.css("padding-bottom","")));a.removeClass("tb_panel_dropdown_openend")}}const d=this;if(!0===a)b();else{if("visual"===c.mode)h(r.document).on("click",b);h(p).on("click",b)}},search(a){var b=h(a.currentTarget);a=b.closest(".tb_modules_panel_wrap");const d=a.find(".tb_module_types .current").first().data("target");b=h.trim(b.val());let e=!1,f=!1,g=!1,k=!1,l=!1;"tb_module_panel_modules_wrap"===d?(e=a.find(".tb_module_outer"),
g=!0):"tb_module_panel_rows_wrap"===d&&c.toolbar.preDesignedRows.is_init?(c.toolbar.preDesignedRows.addNewItems(b),f=a.find(".tb_ui_dropdown_label").data("active"),e=a.find(".predesigned_row"),l=!0):"tb_module_panel_library_wrap"===d&&(e=a.find(".tb_library_item"),f=a.find(".tb_library_types .current").data("target"),k=!0);if(!1!==e){const d=""===b,q=d?!1:new RegExp(b,"i");e.each(function(){if(f&&!this.classList.contains(f))return!0;let a=g?h(this).find(".module_name"):k?h(this).find(".tb_library_item_inner span"):
h(this).find(".tb_predesigned_rows_title");d||q.test(a.text())?h(this).show():h(this).hide()});d?a.removeClass("tb_module_panel_searching"):a.addClass("tb_module_panel_searching");g?a.find(".tb_module_category_content").each(function(){this.parentElement.style.display="block";!1!==d||h(this).find(".tb_module_outer:visible").length||(this.parentElement.style.display="none")}):l&&c.toolbar.preDesignedRows.masonry(a[0].getElementsByClassName("tb_predesigned_rows_container")[0])}},clear(a){a.preventDefault();
...
q<f&&(f=q)),c.iframe[0].parentNode.classList.remove("tb_zoom_bg"),g)l();else{r.document.body.offsetHeight;let d;c.isPreview&&(q={tablet_landscape:[1024,768],tablet:[768,1024],mobile:[375,667]},q[b]!==n&&(f=n===a.tb_device?q[b][0]:"tablet_landscape"===b?a.tb_device[1]:a.tb_device[0],d=n===a.tb_device?q[b][1]:"tablet_landscape"===b?a.tb_device[0]:a.tb_device[1]));c.iframe.one("transitionend",function(){for(let a=u.length-1;-1<a;--a)u[a].style.display="";setTimeout(l,10)});c.iframe[0].style.width=f?
f+"px":"";c.iframe[0].style.height=d?d+"px":""}else l()}},iframeScroll(a){const b=h(r.document);b.off("scroll.themifybuilderresponsive");if(a)b.on("scroll.themifybuilderresponsive",function(){x.scrollTo(0,h(this).scrollTop())})},responsive_grids(a,b){v.LoadCss(tbLocalScript.css_module_url+"responsive-column.css");const c=p.querySelectorAll(".row_inner,.subrow_inner"),e="desktop"===a,f=e||"desktop"===b;for(let d=c.length-1;-1<d;--d){var g=c[d].getAttribute("data-basecol");if(null!==g){let l=c[d].children;
var k=c[d].dataset["col_"+a];let q=l[0],t=l[l.length-1];if(!e){if("desktop"!==b){c[d].classList.remove("tb_3col");let a=c[d].getAttribute("data-col_"+b);a&&c[d].classList.remove(h.trim(a.replace("tb_3col","").replace("mobile","column").replace("tablet","column")))}if(k&&"-auto"!==k&&k!==a+"-auto"){if(k=c[d].getAttribute("data-col_"+a)){c[d].classList.add("tb_grid_classes");c[d].classList.add("col-count-"+g);k=k.split(" ");for(let a=0,b=k.length;a<b;++a)c[d].classList.add(h.trim(k[a].replace("mobile",
"column").replace("tablet","column")))}}else c[d].classList.remove("tb_grid_classes"),c[d].classList.remove("col-count-"+g)}if(f)for(let a=0,b=l.length;a<b;++a)g=h(l[a]).data("w"),g!==n&&(l[a].style.width=e?g+"%":"");"rtl"===c[d].getAttribute("data-"+a+"_dir")?(q.classList.remove("first"),q.classList.add("last"),t.classList.remove("last"),t.classList.add("first"),c[d].classList.add("direction-rtl")):(q.classList.remove("last"),q.classList.add("first"),t.classList.remove("first"),t.classList.add("last"),
...
"multiple":"single"):d+"|single");else if(e.contains("tb_radio_input_container")){e=a.getElementsByTagName("input");f=null;for(a=e.length-1;-1<a;--a)if(!0===e[a].checked){f=e[a];break}null===f||"desktop"!==c.activeBreakPoint&&f.classList.contains("responsive_disable")||(d=f.value)}else if(e.contains("tb_search_container"))d=a.previousElementSibling.dataset.value;else if(e.contains("tb_row_js_wrapper")){d=[];var k=a.getElementsByClassName("tb_repeatable_field_content");a=0;for(e=k.length;a<e;++a){f=
k[a].getElementsByClassName("tb_lb_option_child");d[a]={};for(var l=0,m=f.length;l<m;++l)(g=this.parseSettings(f[l],!0))&&(d[a][g.id]=g.v)}}else if(e.contains("module-widget-form-container"))d=h(a).find(":input").themifySerializeObject();else if(e.contains("tb_widget_select"))d=a.getElementsByClassName("selected")[0],d=d!==n?d.dataset.value:"";else if(e.contains("tb_sort_fields_parent")){f=a.children;d=[];a=0;for(e=f.length;a<e;++a)if(g=f[a].getAttribute("data-type")){l=f[a].getElementsByClassName("tb_sort_field_dropdown")[0];
g={type:g,id:f[a].getAttribute("data-id")};if(l!==n)for(g.val={},k=l.getElementsByClassName("tb_lb_sort_child"),l=k.length-1;-1<l;--l)(m=this.parseSettings(k[l],!0))&&(g.val[m.id]=m.v);else m=f[a].getElementsByTagName("input")[0],l=m.value,""!==l&&(g.val=JSON.parse(l));d.push(g)}0===d.length&&(d="")}else if(e.contains("tb_accordion_fields"))for(f=a.children,d={},a=0,e=f.length;a<e;++a){if(k=f[a].getAttribute("data-id"))m=f[a].getElementsByTagName("input")[0],l=f[a].getElementsByClassName("tb_accordion_fields_options")[0],
g={},l!==n?g.val=this.serialize(l,null,!0):(l=m.value,""!==l&&(g.val=JSON.parse(l))),d[k]=g}else if(e.contains("tb_toggleable_fields"))for(f=a.children,d={},a=0,e=f.length;a<e;++a){if(k=f[a].getAttribute("data-id"))m=f[a].getElementsByTagName("input")[0],l=f[a].getElementsByClassName("tb_toggleable_fields_options")[0],g={on:f[a].getElementsByClassName("tb_switcher")[0].getElementsByClassName("toggle_switch")[0].value},l!==n?g.val=this.serialize(l,null,!0):(l=m.value,""!==l&&(g.val=JSON.parse(l))),
d[k]=g}else if(d=a.value,x.tbpDynamic!==n&&b===tbpDynamic.field_name){if(""===d)return!1;"string"===typeof d&&(d=JSON.parse(d))}else{if(b===c.GS.key&&"desktop"!==c.activeBreakPoint)return!1;""!==d&&("builder_content"===b?"string"===typeof d&&(d=JSON.parse(d)):(a=a.getAttribute("data-opacity"),null!==a&&""!==a&&1!=a&&"0.99"!=a&&(d+="_"+a)))}if(d===n||null===d)d="";return{id:b,v:d}},serialize(a,b,c){c=c||!1;var d={};a="object"===typeof a?a:r.document.getElementById(a);if(null!==a){a=a.getElementsByClassName(c?
...
this.insertAdjacentHTML("afterbegin",'<div class="tb_overlay"></div>')});var b="themify_builder_content-"+e.id;e.html=f[0].innerHTML;themifyBuilder.post_ID=ThemifyStyles.builder_id=e.id;f[0].insertAdjacentHTML("afterbegin",k.replace("#postID#",e.id));h("."+b).each(function(){h(this).closest(".active_module").find(".themify-builder-generated-css").first().prop("disabled",!0)});c.Instances.Builder[0].el.classList.remove("tb_active_builder");f.removeClass("active_module module").closest(".tb_holder").removeClass("tb_holder").addClass("tb_layout_part_parent").closest(".module_row").addClass("tb_active_layout_part_row");
g.attr("id",b).removeClass("not_editable_builder").addClass("tb_active_builder").empty();e.el=f;c.id=e.id;var d=[];c.builderIndex=1;c.Instances.Builder[c.builderIndex]=new c.Views.Builder({el:g,collection:new c.Collections.Rows(a),type:c.mode});a=c.Instances.Builder[c.builderIndex].render().el.querySelectorAll("[data-cid]");b=0;for(var l=a.length;b<l;++b)d[a[b].dataset.cid]=1;a=null;c.bootstrap(d,function(){f.triggerHandler("tb_layout_part_before_init");d=c.activeModel=null;c.Utils.loadContentJs(g);
...
3))if(h(this).off("ajaxComplete",q),200===f.status){d.el=c.liveStylingInstance.$liveStyledElmt;e=d.el.children(".themify_builder_content");var k=e[0].innerHTML,l="";d.el.children(".themify-builder-generated-css").each(function(){l+=this.outerHTML});h(".themify_builder_content-"+d.id).each(function(){var a=h(this).closest(".module");a.children("link.themify-builder-generated-css").remove();""!==l&&a[0].insertAdjacentHTML("afterbegin",l);this.innerHTML=k;c.Utils.loadContentJs(h(this))});l=k=null;m.showLoader("hide");
...
d!==n&&d.click();d=null}if(c.undoManager.hasUndo()||null!==this.isReload||b){var e=this;this.old_settings=this.html=null;m.showLoader("show");c.Utils.saveBuilder(function(d){d.success&&(e.options=d.data.builder_data,c.hasChanged=null,e.isSaved=!0,b&&e.close(a))},1)}else m.showLoader("show"),setTimeout(function(){m.showLoader("hide")},100)}},reLoad(a,b,d){function e(){"visual"===c.mode&&(c.liveStylingInstance.setCss(c.Mixins.Builder.toJSON(c.Instances.Builder[k].el)),c.Utils.loadContentJs(c.Instances.Builder[k].$el),
...
k=c.builderIndex,l=null,u="";c.Mixins.Builder.updateModuleSort(null,"destroy");g||(c.Models.Registry.destroy(),c.Instances.Builder={});"visual"===c.mode?(u="#themify_builder_content-"+b,c.id=b,g||(c.liveStylingInstance.reset(),c.editing=!1,v.body.addClass("sidebar-none full_width"),h("#sidebar,.page-title").remove())):u="#tb_row_wrapper";if(g){b=c.Instances.Builder[k].el.querySelectorAll("[data-cid]");c.Forms.LayoutPart.isReload=!0;for(var q=0,t=b.length;q<t;++q){var w=b[q].dataset.cid,B=c.Models.Registry.lookup(w);
B&&(B.destroy(),c.Models.Registry.remove(w))}b=null;c.Instances.Builder[k].$el.empty()}c.Instances.Builder[k]=new c.Views.Builder({el:u,collection:new c.Collections.Rows(f),type:c.mode});c.Instances.Builder[k].render();c.undoManager.reset();if(g){l=[];b=c.Instances.Builder[k].el.querySelectorAll("[data-cid]");q=0;for(t=b.length;q<t;++q)l[b[q].dataset.cid]=1;b=null}"visual"===c.mode?c.bootstrap(l,e,a.used_gs!==n?a.used_gs:null):e()},isValidate(a){var b=a.getElementsByClassName("tb_must_validate"),
...
f=a.getElementsByClassName(b+"_inner")[0],g=e.get("gutter"),h=e.get("column_alignment"),l=e.get("column_h"),m=e.get("desktop_dir"),q="row"===b?e.get("styling"):null;b=[];for(var t={},w=f.children,p=0,r=w.length;p<r;++p)w[p].className=w[p].className.replace(/first|last/ig,""),1!==r&&(0===p?w[p].className+="rtl"===m?" last":" first":p===r-1&&(w[p].className+="rtl"===m?" first":" last"));w=w.length;b.push("col-count-"+w);t["data-basecol"]=w;null!==q&&q.row_anchor!==n&&""!==q.row_anchor&&(a.getElementsByClassName("tb_row_anchor")[0].textContent=
q.row_anchor);"gutter-default"!==g&&b.push(g);l&&b.push("col_auto_height");h||(h="col_align_top");b.push(h);"ltr"!==m&&b.push("direction-rtl");for(a=d.length-1;-1<a;--a)m=e.get(d[a]+"_dir"),"ltr"!==m&&""!==m&&(t["data-"+d[a]+"_dir"]=m),"desktop"!==d[a]&&(w=e.get("col_"+d[a]),"-auto"!==w&&""!==w&&w!==n&&(t["data-col_"+d[a]]=w));for(p=b.length-1;-1<p;--p)b[p]&&f.classList.add(b[p]);for(p in t)f.setAttribute(p,t[p])},clear(a,b,d){b===n&&(b=Array.isArray(a));var e=!0===b?[]:{},f=x.tbpDynamic!==n?tbpDynamic.field_name:
!1;d||(d=1);for(var g in a)if(Array.isArray(a[g])){++d;var k=this.clear(a[g],!0,d);0<k.length&&(!0===b?e.push(k):e[g]=k)}else if(g===f)if("{}"===a[g]||""===a[g])delete a[g],delete e[g];else{k=a[g];"string"===typeof k&&(k=JSON.parse(k));for(var l in k)"undefined"===typeof k[l].repeatable&&(k[l].item===n?delete k[l]:a[l]!==n&&(delete a[l],delete e[l]));a[g]=e[g]=k}else if("object"===typeof a[g])++d,k=this.clear(a[g],!1,d),h.isEmptyObject(k)||(e[g]=k);else if(null!==a[g]&&a[g]!==n&&""!==a[g]&&"def"!==
...
g||"cover_gradient-css"===g||"cover_gradient_hover-css"===g||"background_image-type_image"===g||"custom_parallax_scroll_reverse_reverse"===g||"|single"===a[g]||"|multiple"===a[g]||("custom_parallax_scroll_reverse"===g||"custom_parallax_scroll_fade"===g||"visibility_all"===g||"sticky_visibility"===g)&&!a[g])delete a[g],delete e[g];else{if("builder_content"===g)"string"===typeof a[g]&&(a[g]=JSON.parse(a[g])),a[g]=this.clear(a[g],!0,1);else if(1===d){k=[];if("px"===a[g]&&-1!==g.indexOf("_unit",2)){var m=
g.replace("_unit","");a[m]||k.push(g)}else if(0===g.indexOf("checkbox_")&&-1!==g.indexOf("_apply_all",6)){a[g]?e[g]=a[g]:k.push(g);m=g.replace("_apply_all","").replace("checkbox_","");for(var q=["top","left","right","bottom"],t=3;-1<t;--t){var p=m+"_"+q[t]+"_unit";"px"===a[p]?k.push(p):a[p]!==n&&null!==a[p]&&""!==a[p]&&(e[p]=a[p])}}else-1!==g.indexOf("gradient",3)?("180"==a[g]||"linear"===a[g]||a[g]===h.ThemifyGradient.default||!1===a[g]&&-1!==g.indexOf("-circle-radial",3))&&k.push(g):("background_zoom"===
g&&""===a[g]||"none"===a[g]&&-1!==g.indexOf("frame_layout")||"solid"===a[g]||!1===a[g]&&(-1!==g.indexOf("_user_role",3)||-1!==g.indexOf("_appearance",3)))&&k.push(g);if(0<k.length){for(t=k.length-1;-1<t;--t)delete e[k[t]],delete a[k[t]];k.length=0;continue}}!0===b?e.push(a[g]):e[g]=a[g]}else delete e.custom_parallax_scroll_reverse,delete e.custom_parallax_scroll_fade,delete e[g],delete a.custom_parallax_scroll_reverse,delete a.custom_parallax_scroll_fade,delete a[g];return e},clearElementId(a,b){for(var d in a){!0===
...
(!1===a||b[e].classList.contains(a))){var f=b[e],g=f.getAttribute("id").replace("tb_plupload_upload_ui",""),k=h.extend(!0,{},this.pconfig),l=f.getAttribute("data-extensions"),p=["browse_button","container","drop_element","file_data_name"];k.multipart_params.imgid=g;for(var q=p.length-1;-1<q;--q)k[p[q]]=g+this.pconfig[p[q]];k.filters[0].extensions=null!==l?l:null!==c.activeModel?k.filters[0].extensions.replace(/,zip|,txt/,""):"zip,txt";g=new r.plupload.Uploader(k);f.classList.add("tb_plupload_init");
...
g,h(this).css("width",a+"%"))})}else{var k={"col6-1":14,"col5-1":17.44,"col4-1":22.6,"col4-2":48.4,"col2-1":48.4,"col4-3":74.2,"col3-1":31.2,"col3-2":65.6},l={"col6-1":15.33,"col5-1":18.72,"col4-1":23.8,"col4-2":49.2,"col2-1":49.2,"col4-3":74.539,"col3-1":32.266,"col3-2":66.05},p={"col6-1":16.666,"col5-1":20,"col4-1":25,"col4-2":50,"col2-1":50,"col4-3":75,"col3-1":33.333,"col3-2":66.666};(a?a.children(".module_column").find(".tb_grid_drag"):h(".tb_grid_drag")).each(function(){var a,b,d,e,g=0,n,u=
!1,r=0,G=!1,E,x,y,z=null,A=null,C;h(this).draggable({axis:"x",cursor:"col-resize",distance:0,scroll:!1,snap:!1,containment:".row_inner",helper(c){a=h(c.currentTarget);b=a.closest(".subrow_inner");0===b.length&&(b=a.closest(".row_inner"));n=a[0].classList.contains("tb_drag_right")?"w":"e";E="w"===n?"tb_grid_drag_right_tooltip":"tb_grid_drag_left_tooltip";G=m.clone(b.closest(".module_row"));b.addClass("tb_drag_column_start");return h('<div class="ui-widget-header tb_grid_drag_tooltip '+E+'"></div><div class="ui-widget-header tb_grid_drag_tooltip"></div>')},
start(c,f){d=b.children(".module_column");e=a.closest(".module_column");y=b[0].classList.contains("direction-rtl");"w"===n?(u=y?e.prev(".module_column"):e.next(".module_column"),g=a.outerWidth(),C=e.outerWidth()):(u=y?e.next(".module_column"):e.prev(".module_column"),C=g=e.outerWidth());g=parseInt(g);r=parseInt(u.outerWidth())-2;x=b.outerWidth();z=e.addClass("tb_drag_column_current").children("."+E)[0];A=e.children(".tb_grid_drag_tooltip").last()[0]},stop(a,m){h(".tb_grid_drag_tooltip").remove();
b.removeClass("tb_drag_column_start");a=Math.ceil(100*(e.outerWidth()/x));e.removeClass("tb_drag_column_current").css("width",a+"%");var q=k;a=3.2;b[0].classList.contains("gutter-narrow")?(q=l,a=1.6):b[0].classList.contains("gutter-none")&&(q=p,a=0);var t=a*(d.length-1);d.each(function(a){a!==u.index()&&(h(this).prop("style").width?a=parseFloat(h(this).prop("style").width):(a=h.trim(f.filterClass(h(this).attr("class")).replace("first","").replace("last","")),a=q[a]),t+=a)});u.css("width",100-t+"%");
u=u.add(e);f.setCompactMode(u);a=b.closest(".module_row");m=!0===c.hasChanged;c.hasChanged=!0;c.undoManager.push(a.data("cid"),G,a,"row");c.hasChanged=m;v.body.triggerHandler("tb_grid_changed",[a]);z=A=g=r=x=C=u=E=e=n=y=b=d=null},drag(a,b){if(u&&0<u.length&&(a=parseInt(b.position.left),a=g+("e"===n?-a:a),b=parseFloat(100*a/x),5<=b&&100>b)){var c=r;c+="w"===n?-(a-C):C-a;var d=parseFloat(100*c/x);5<d&&100>d&&(u.css("width",c+"px"),e.css("width",a+"px"),z.innerHTML=b.toFixed(2)+"%",A.innerHTML=d.toFixed(2)+
...
Object.keys(c.Instances.Builder).length,g=c.Instances.Builder[b],k=this;e=g.$el.data("postid");g=c.Mixins.Builder.toJSON(g.el);if(!0===d)return{id:e,data:g};c.GS.setImport(c.GS.styles,null,null,!0);(function(a,b){null===y&&(y=themifyBuilder.custom_css,delete themifyBuilder.custom_css);a={action:"tb_save_data",tb_load_nonce:themifyBuilder.tb_load_nonce,id:a,custom_css:y,sourceEditor:"visual"===c.mode?"frontend":"backend"};k.saveCss(b,a.custom_css,a.id);a.data=JSON.stringify(c.Utils.clear(b));return h.ajax({type:"POST",
url:themifyBuilder.ajaxurl,cache:!1,data:a})})(e,g).always(function(d,e){++b;f===b?(h.isFunction(a)&&a.call(k,d,e),"success"!==e?m.showLoader("error"):(m.showLoader("hide"),c.editing=!0,v.body.triggerHandler("themify_builder_save_data",[d,e]))):setTimeout(function(){k.saveBuilder(a,b)},50)})},saveCss(a,b,d){return h.ajax({type:"POST",url:themifyBuilder.ajaxurl,cache:!1,data:{css:JSON.stringify(c.GS.createCss(a,null,!0)),action:"tb_save_css",custom_css:b,tb_load_nonce:themifyBuilder.tb_load_nonce,
...
e.custom_css=function(a,b,d,e){"visual"===c.mode&&d.removeClass(a.getAttribute("data-prev")).addClass(e);return!0};e.layout=function(a,b,d,e){"visual"===c.mode&&c.liveStylingInstance.bindRowWidthHeight(b,e,d);return!0};e.hide_anchor=function(a,b,d,e){"visual"===c.mode&&"1"===e&&d.data("hideAnchor",e).attr("data-hide-anchor",e);return c.hasChanged=!0};a.addEventListener(d,function(a){var f=null!==c.activeModel&&c.ActionBar.cid===c.activeModel.cid,k=!m.Lightbox.$lightbox[0].contains(this),l="hide_anchor"!==
b?this.id:"hide_anchor",u="custom_css_id"===l,q=!0!==u||!1!==k&&!0!==f?n:m.Lightbox.$lightbox[0].getElementsByClassName("builder_save_button")[0];var t=!0===k&&!1===f?h(".tb_element_cid_"+c.ActionBar.cid):"visual"===c.mode?c.liveStylingInstance.$liveStyledElmt:h(".tb_element_cid_"+c.activeModel.cid);var w=!1===f&&!0===k?m.clone(t[0]):null;var r=this.value;"keyup"===d&&"custom_css"!==b?((r=r.trim())&&(r=r.replace(/[^a-zA-Z0-9\-_]+/gi,"")),this.value=r):"layout"===b?r=a.detail.val:"hide_anchor"===b&&
(r=this.checked?"1":"0");if(e[b].call(e,this,l,t,r)){u&&(h(this).next(".tb_field_error_msg").remove(),q!==n&&q.classList.remove("tb_disable_save"));if(!0===k){var v=function(){var a=r;"keyup"===d&&(this.removeEventListener("change",v,{passive:!0,once:!0}),this.removeAttribute("data-isInit"),a=this.value.trim());var b=t.data("cid"),e=c.Models.Registry.lookup(b),f=h.extend(!0,{},e.get("styling"));f||(f={});var g=h.extend(!0,{},f);f[l]=a;e.set({styling:f},{silent:!0});null!==w&&c.undoManager.push(b,
w,t,"save",{bsettings:g,asettings:h.extend(!0,{},f)})};"keyup"===d?this.getAttribute("data-isInit")||(this.setAttribute("data-isInit",1),this.addEventListener("change",v,{passive:!0,once:!0})):v()}c.hasChanged=!0}else u&&(a=p.createElement("span"),a.className="tb_field_error_msg",a.textContent=ThemifyConstructor.label.errorId,this.parentNode.insertBefore(a,this.nextSibling),q!==n&&q.classList.add("tb_disable_save"));!0===f&&(f=k?m.Lightbox.$lightbox.find("#"+l):h("#"+c.ActionBar.el.id).find("#"+l),
...
if(b.hoverCid===f)return;b.hoverCid=f;g=c.Models.Registry.lookup(f);f=g.get("elType");if("module"===f)e=!0;else if("visual"===c.mode){b.clear();c.EdgeDrag.addEdges(f,g,d);return}}}!0===e&&b.click(a)}}},rightClickGS(a,b,d){this.disable=!0;null!==c.activeModel&&h(".builder_save_button",ThemifyBuilderCommon.Lightbox.$lightbox).click();var e=c.Instances.Builder[c.builderIndex].el.getElementsByClassName("tb_element_clicked"),f=c.GS.key;b=b.split(" ");for(var g=b.length,k=e.length-1;-1<k;--k){var l=c.Models.Registry.lookup(e[k].getAttribute("data-cid")),
p=m.clone(e[k]),q="module"===l.get("elType")?"mod_settings":"styling",n=h.extend(!0,{},l.get(q)),w=h.extend(!0,{},n);c.activeModel=l;if(n[f])if(!0===d)a&&-1!==n[f].indexOf(a)&&(n[f]=n[f].split(" "),n[f].splice(n[f].indexOf(a),1),n[f]=n[f].join(" "));else for(var r=0;r<g;++r)-1===n[f].indexOf(b[r])&&(n[f]+=" "+b[r]);else{if(0===g)continue;n[f]=b.join(" ")}r={};r[q]=n;l.set(r,{silent:!0});c.GS.generateValues(a,n[f].split(" "),d);c.undoManager.push(l.cid,p,h(e[k]),"save",{bsettings:w,asettings:n})}this.disable=
...
x.get("styling");if("reset"===b||"gs_r"===b){if("gs_r"!==b||w[c.GS.key]!==n){if(null!==c.activeModel&&c.activeModel.cid===v){var z=ThemifyBuilderCommon.Lightbox.$lightbox.find(".reset-styling")[0];if(z!==n){z.click();continue}}z=m.clone(f[e]);var A;c.activeModel=x;"reset"===b&&(ThemifyConstructor.component=y,ThemifyConstructor.values=w);var D="module"===y?"mod_setting":"styling";"visual"===c.mode&&(c.liveStylingInstance.$liveStyledElmt?c.liveStylingInstance.prefix=ThemifyStyles.getBaseSelector("module"===
y?c.activeModel.get("mod_name"):y,c.activeModel.get("element_id")):c.liveStylingInstance.init(!0),c.liveStylingInstance.$liveStyledElmt=h(f[e]));y=h.extend(!0,{},w);"reset"===b?(w=ThemifyConstructor.resetStyling(a,null!==k&&k.cid!==v),"visual"===c.mode&&(A=h.extend(!0,{},w)),w=h.extend(!0,{},ThemifyConstructor.values)):(delete w[c.GS.key],c.GS.generateValues(null,[],!0));var H={};H[D]=w;x.set(H,{silent:!0});c.hasChanged=!0;c.undoManager.push(v,z,h(f[e]),"save",{bsettings:y,asettings:w,styles:A});
A=null}}else("delete"!==b&&"visibility"!==b||"column"!==y)&&x.trigger(b,a,a.target,g)}"reset"===b?(c.hasChanged=u,c.activeModel=k,ThemifyConstructor.values=l,ThemifyConstructor.component=q,ThemifyConstructor.beforeData=p,"visual"===c.mode&&(c.liveStylingInstance.$liveStyledElmt=r,c.liveStylingInstance.prefix=t)):"edit"!==b&&(c.activeModel=null);d.disable=null}"visibility"!==b&&d.hideContextMenu()}}},f=function(a){a.stopPropagation();a.target.classList.contains("tb_inner_action_more")&&(a=a.target.getElementsByTagName("ul")[0],
...
"rightClick")),e.textContent="module"===q?themifyBuilder.modules[u.get("mod_name")].name:q);h.addEventListener("click",m);var w=function(a){"transform"===a.propertyName?(this.removeEventListener("transitionend",w,{passive:!0}),c.Utils.addViewPortClass(this),d.contextMenuAnimate=null):(this.style.top=l+"px",!0===g&&(this.style.left=k+"px"))};this.addEventListener("transitionend",w,{passive:!0});c.undoManager.hasUndo()||(this.className+=" tb_undo_disabled");"column"===q&&(this.className+=" tb_visibility_disabled");
...
else{"visual"!==c.mode||"A"!==d&&null===b.closest("a")||a.preventDefault();var u=g.getAttribute("data-cid");f=c.Models.Registry.lookup(u);var q=f.get("elType"),t="row"===q&&g.classList.contains("tb-page-break");if(f){if("dblclick"===k){if((!0===l||"INPUT"===d||!0===t||b.classList.contains("tb_dragger_lightbox")||null!==b.closest(".tb_clicked"))&&"tb_row_options"!==b.id)return;a.preventDefault();a.stopPropagation();!1===l&&!0!==this.isHoverMode?(g.classList.add("tb_element_clicked"),v.body[0].classList.add("tb_action_active"),
...
(a.preventDefault(),a.stopPropagation(),f.trigger("delete",a,b));else if((!1===d||"module"===q&&!0===w)&&null!==b.closest(".tb_action_wrap"))"click"===k&&this.actions(a);else if(!0===w&&"click"===k&&!0===this.needClear)!0===l&&!1===e&&f.trigger("edit",a,b);else if(this.clear(),!0===B&&"click"===k&&!1===e&&!1===l&&!0===this.needClear){v.body[0].classList.add("tb_action_active");var F=this,x=function(){p.removeEventListener("mousemove",x,{passive:!0,once:!0});null===F.cid&&(v.body[0].classList.remove("tb_action_active"),
F.clearClicked())};p.removeEventListener("mousemove",x,{passive:!0,once:!0});p.addEventListener("mousemove",x,{passive:!0,once:!0})}else{this.cid=u;this.type=q;k=p.getElementById("tmpl-builder_"+q+"_action").content.cloneNode(!0);if(!0===d){this.prevExpand="module"===q?g.getElementsByClassName("tb_module_action")[0]:b;if(this.prevExpand===n){this.clear();return}this.prevExpand.appendChild(k);this.prevExpand.setAttribute("id",this.el.id);this.prevExpand.style.top="";this.prevExpand.closest(".tb_action_wrap").classList.add("tb_clicked");
!0===w&&"module"===q&&(k=!0,e=g.getBoundingClientRect(),70>e.height||200>e.width?(this.prevExpand.classList.add("tb_small_action_bar"),this.prevExpand.classList.remove("tb_small_action_bar_top"),this.prevExpand.classList.remove("tb_small_action_bar_bottom"),this.prevExpand.style.top=0,40>this.prevExpand.getBoundingClientRect().top?(this.prevExpand.style.top="100%",this.prevExpand.classList.add("tb_small_action_bar_top")):this.prevExpand.classList.add("tb_small_action_bar_bottom"),70>e.height?this.prevExpand.classList.add("tb_small_action_bar_height"):
this.prevExpand.classList.remove("tb_small_action_bar_height"),200>e.width?this.prevExpand.classList.add("tb_small_action_bar_width"):this.prevExpand.classList.remove("tb_small_action_bar_width"),k=!1):this.prevExpand.classList.remove("tb_small_action_bar"),"visual"===c.mode&&(!0===k&&75>e.height&&(e=this.prevExpand.nextElementSibling,null!==e&&e.classList.contains("tb_module_btn_plus")&&null!==e.offsetParent||(e=g.parentNode.nextElementSibling),null!==e&&(e=this.prevExpand.getBoundingClientRect().bottom-
e.getBoundingClientRect().top,0<=e&&(this.prevExpand.style.top=this.prevExpand.offsetTop-e-2+"px"))),c.EdgeDrag.addEdges(f.get("mod_name"),f,g)))}else("row"!==q||"row"===q&&null!==this.breadCrumbsPath.lightbox)&&this.setBreadCrumbs(g),this.el.className="tb_show_toolbar tb_"+q+"_action",e=p.createElement("div"),e.className="tb_action_label_wrap",e.appendChild(k),"visual"===c.mode&&("module"===q?(k=f.get("mod_name"),this.el.className+=" tb_"+k+"_action",k=themifyBuilder.modules[k].name):(k=q,"row"===
q&&(u=f.get("styling").row_anchor,u!==n&&(u=u.trim(),""!==u&&(k+=" #"+u)))),u=p.createElement("div"),u.className="tb_data_mod_name",u.textContent=k.charAt(0).toUpperCase()+k.slice(1),e.appendChild(u)),this.el.appendChild(e);!0!==w&&(g.classList.add("tb_element_clicked"),v.body[0].classList.add("tb_action_active"),"visual"===c.mode&&c.EdgeDrag.addEdges("module"===q?f.get("mod_name"):q,f,g));if(!0===l&&(f.trigger("edit",a,b),!0===w||null!==this.disablePosition&&!1!==d&&!0===w))return;null===this.disablePosition&&
...
p.getElementsByClassName("tb_element_clicked"),f=e.length;if(0<f){a.preventDefault();a.stopPropagation();var g=null,k=null,l=n,u=!0===a.ctrlKey||!0===a.metaKey;46===d||8===d?g="delete":!0===u&&(67===d?(g="copy",f=1):68===d?g="duplicate":86===d&&(g="paste",!0===a.shiftKey&&(k="style")));1<f&&("delete"===g||"paste"===g)&&(l=!0,null!==c.activeModel&&m.Lightbox.$lightbox.is(":visible")&&ThemifyConstructor.saveComponent());for(b=f-1;-1<b;--b){var q=e[b];if(null===g){if(!0===u&&1===f&&(38===d||40===d)){var t=
...
r.next().after(r),B.sortable("option","update")({type:"sortupdate"},{item:r}),B.sortable("option","stop")(null,{item:r,helper:null}),!0!==this.isHoverMode&&q.classList.add("tb_element_clicked"))}}}else"delete"===g&&q.classList.contains("module_column")||(q=c.Models.Registry.lookup(h(q).closest("[data-cid]")[0].getAttribute("data-cid")),q.trigger(g,a,k,l))}"delete"!==g&&!0===this.isHoverMode||this.clear()}}}else if(a.stopPropagation(),"click"===a.type&&null!==b.closest(".switch-wrapper"))b.classList.contains("toggle_switch")&&
...
e=this.type,f=h(".tb_element_cid_"+this.cid).first(),g=!1,k=c.activeBreakPoint,l="desktop"===k;a=m.clone(f.closest(".module_row"));g="subrow"===e;var u=f.find("."+e+"_inner").first();if(l){e=u;var q=b.data("col");e=e.add(h("#tb_rgrids"));q===n&&(q=1,b.data("col",q));for(k=6;0<k;--k)e.removeClass("col-count-"+k);e.addClass("col-count-"+q);u.attr("data-basecol",q);l&&b.closest(".tb_grid_menu").find(".tb_grid_reposnive .tb_grid_list").each(function(){var a=h(this).find(".selected"),b=h(this).data("type"),
...
" tb_grid_classes col-count-"+u.attr("data-basecol")).attr("data-col_"+k,a)):u.removeClass("tb_grid_classes tb_3col col-count-"+u.attr("data-basecol")+" "+u.attr("data-col_"+k)).attr("data-col_"+k,""),"visual"===c.mode&&(h("body",r.document).height(p.body.scrollHeight),c.Utils.calculateHeight()),c.Utils.setCompactMode(u.children(".module_column")),!1;b=u.children(".module_column");l=d.length;e="module_column"+(g?" sub_column":"")+" col";for(k=0;k<l;++k)f=b.eq(k),0<f.length?f.removeClass(c.Utils.gridClass.join(" ")).addClass(e+
d[k]):c.Utils._addNewColumn({newclass:e+d[k],component:g?"sub-column":"column"},u[0]);l<u.children().length&&u.children(".module_column").eq(l-1).nextAll().each(function(){h(this).find(".tb_holder").first().children().appendTo(h(this).prev().find(".tb_holder").first());h(this).remove()});d=u.children();d.removeClass("first last");u.hasClass("direction-rtl")?(d.last().addClass("first"),d.first().addClass("last")):(d.first().addClass("first"),d.last().addClass("last"));c.Utils.columnDrag(u,!0);f=u.closest(".module_row");
...
d=c.Models.Registry.lookup(this.cid),e=d.get("gutter"),f=m.clone(b);b=b.find("."+this.type+"_inner").first();c.Utils.columnDrag(b,!1,e,a);b.removeClass(e).addClass(a);d.set({gutter:a},{silent:!0});c.undoManager.push(this.cid,f,h(".tb_element_cid_"+this.cid).first(),"row")}},gridMenu(a){var b=c.activeBreakPoint,d="desktop"===b,e=c.Models.Registry.lookup(this.cid),f=e.get(b+"_dir"),g=e.get("column_alignment"),k=e.get("column_h");e=e.get("gutter");var l=p.getElementsByClassName("tb_element_cid_"+this.cid)[0].getElementsByClassName(this.type+
"_inner")[0],m=!0===d?n:l.getAttribute("data-col_"+b),q=l.children,r=q.length,w=[];for(l=0;l<r;++l)w.push(c.Utils._getColClass(q[l].className.split(" ")));q="tb_rgrids"===a.id?a:h(a).find("#tb_rgrids")[0];for(l=6;-1<l;--l)q.classList.remove("col-count-"+l);q.classList.add("col-count-"+r);w="grid-layout-"+w.join("-");a=a.getElementsByClassName("tb_grid_"+b)[0];q=a.getElementsByClassName("tb_grid_list")[0].getElementsByTagName("li");m="-auto"!==m&&m?"grid-layout-"+m.replace(/column|tb_3col/ig,"").trim():
!1;!1!==d||!1!==m&&1!==r||(m=b+"-auto");for(l=q.length-1;-1<l;--l)!0===d&&q[l].classList.contains(w)||!1===d&&q[l].classList.contains(m)?q[l].classList.add("selected"):q[l].classList.remove("selected");if("ltr"!==f)for(q=a.getElementsByClassName("tb_column_direction")[0].getElementsByTagName("li"),l=q.length-1;-1<l;--l)q[l].getAttribute("data-dir")===f?q[l].classList.add("selected"):q[l].classList.remove("selected");if(!0===d){if("col_align_top"!==g||!0===D)for(b=a.getElementsByClassName("tb_column_alignment")[0].getElementsByTagName("li"),
l=b.length-1;-1<l;--l)b[l].getAttribute("data-alignment")===g?b[l].classList.add("selected"):b[l].classList.remove("selected");if("gutter-default"!==e)for(g=a.getElementsByClassName("tb_column_gutter")[0].getElementsByTagName("li"),l=g.length-1;-1<l;--l)g[l].getAttribute("data-value")===e?g[l].classList.add("selected"):g[l].classList.remove("selected");if(k)for(g=a.getElementsByClassName("tb_column_height")[0].getElementsByTagName("li"),l=g.length-1;-1<l;--l)g[l].getAttribute("data-value")==k?g[l].classList.add("selected"):
...
c.toolbar.el.offsetTop+this.topH,g="visual"===c.mode?p.body:c.Instances.Builder[0].el,k=g.clientWidth;b=b.nodeType!==n?h(b).offset():b;b.right=b.bottom="";b.left-=parseFloat(e/2);b.top-=d;b.left+e>k?(b.left="auto",b.right=10):0>b.left&&(b.left=30);b.top>g.clientHeight?"visual"!==c.mode&&(b.top="auto",b.bottom=50):f>b.top&&(a.dataset.top=!0,b.top+=2*d-25,"visual"!==c.mode&&(b.top-=d/2));for(var l in b)a.style[l]="auto"!==b[l]&&""!==b[l]?b[l]+"px":b[l]}};c.Forms.register_validator=function(a,b){this.Validators[a]=
...
if(e===n)return;c.activeModel=c.Models.Registry.lookup(e.getAttribute("data-cid"));b.element_id=c.activeModel.get("element_id");this.previousModel=c.activeModel.cid;d=!0;c.Utils.scrollToDropped(e)}else null!==c.activeModel&&(this.previousModel=c.activeModel.cid,b.element_id=c.activeModel.get("element_id"),ThemifyConstructor.saveComponent(!0));var f=this.styles[a],g=this,k=ThemifyConstructor.label.done,l="visual"===c.mode?h.extend(!0,{},c.liveStylingInstance):null;e=h.extend(!0,{},f.data[0]);var r=
...
k;q.model.destroy();"visual"===c.mode&&(l.prefix&&(c.liveStylingInstance=l,c.liveStylingInstance.$liveStyledElmt=h(p.querySelector(l.prefix)),null===g.previousModel||"row"!==r&&"column"!==r&&"subrow"!==r||(a=c.Models.Registry.lookup(g.previousModel))&&"module"===a.get("elType")&&(c.liveStylingInstance.getComponentBgOverlay().remove(),c.liveStylingInstance.removeBgSlider(),c.liveStylingInstance.removeBgVideo(),c.liveStylingInstance.$liveStyledElmt.children(".tb_row_frame").remove(),c.liveStylingInstance.$liveStyledElmt[0].classList.remove("builder-zoom-scrolling",
"builder-zooming"))),l=g.liveInstance=null);g.activeGS=null};v.body.one("themify_builder_lightbox_close.tb_gs_edit",function(a){t();d?g.previousModel=null:g.reopenPreviousPanel()}).one("themify_builder_save_component.tb_gs_edit",function(a,b){a=g.activeGS;const e=g.styles[a],f=g.previousModel;delete ThemifyConstructor.values.cid;ThemifyConstructor.setStylingValues(c.activeBreakPoint);var k=ThemifyConstructor.values;const l=c.activeModel;delete k[this.key];"row"===r||"subrow"===r?(e.data[0].styling=
