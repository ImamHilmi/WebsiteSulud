    ...
    'use strict';
            ...
            youtube = function (el,url,id) {
				if(is_mobile===false && id){
					...
					let src='https://www.youtube.com/embed/'+id+'?modestbranding=1&playsinline=1&controls=0&showinfo=0&rel=0&disablekb&fs=0&version=3&allowfullscreen=false&wmode=transparent&iv_load_policy=3&playerapiid='+player_id+'&playlist='+id,
						w=640,
						h=360,
						autoplay=false;
					if(params.loop){
